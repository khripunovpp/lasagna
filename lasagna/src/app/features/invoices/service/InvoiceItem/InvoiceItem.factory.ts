  ...
  fromDTO(dto: Partial<InvoiceItemDTO>): InvoiceItemBase | undefined {
    switch (dto.type) {
      case InvoiceItemType.Product:
        ...
        return new ProductInvoiceItem(product, dto?.amount, dto?.unit || 'gram', dto?.pinnedDto || null);
      ...
      case InvoiceItemType.Recipe:
        ...
        return new RecipeInvoiceItem(recipe, dto?.amount, dto?.unit || 'gram', dto?.pinnedDto || null);
      //
