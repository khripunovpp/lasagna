...
export class Invoice {
  ...
  public credential_from: string = '';
  public credential_to: string = '';
  ...
  patch(dto: Partial<InvoiceDTO>) {
    ...
    if (dto.credential_from != null) this.credential_from = toString(dto.credential_from);
    if (dto.credential_to != null) this.credential_to = toString(dto.credential_to);
  ...
  copy(): Invoice {
    ...
    copy.rows = this.rows.map(item => item.copy());
    return copy;
  }
