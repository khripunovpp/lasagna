...
import {debounceTime, last, Observable, of} from 'rxjs';
...
import {RecipeFormValue} from '../../add-recipe/add-recipe-form.component';
...
@Component({
  selector: 'lg-common-recipe-section',
  standalone: true,
  templateUrl: './common-recipe-section.component.html',
  styleUrls: ['./common-recipe-section.component.scss'],
  imports: [
    ReactiveFormsModule,
    GapColumnComponent,
    ControlComponent,
...
export class CommonRecipeSectionComponent
  implements OnInit,
    AfterViewInit {
  constructor(
