...
var InputComponent = class _InputComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InputComponent, selectors: [["lg-input"]], contentQueries: function InputComponent_ContentQueries(rf, ctx, dirIndex) {
  ...
  }, inputs: { placeholder: [1, "placeholder"], autoFocus: [1, "autoFocus"], inputType: [1, "inputType"], disable: [1, "disable"], theme: [1, "theme"] }, outputs: { onInputChanged: "onInputChanged", onEnter: "onEnter" }, features: [\u0275\u0275ProvidersFeature([
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => _InputComponent),
      multi: true
    }
  ])], decls: 6, vars: 9, consts: [["input", ""], [1, "lg-input"], [1, "lg-input__before"], [1, "input", 3, "blur", "change", "focus", "input", "keydown.enter", "disabled", "placeholder", "value", "type"], ["type", "button", 1, "lg-input__clear"], [1, "lg-input__after"], [4, "ngTemplateOutlet"], ["type", "button", 1, "lg-input__clear", 3, "click"]], template: function InputComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("disabled", ctx.disable())("placeholder", ctx.placeholder())("value", ctx.value)("type", ctx.inputType());
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.value && !ctx.disable() ? 4 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(((tmp_8_0 = ctx.afterExtraTpl()) == null ? null : tmp_8_0.templateRef) ? 5 : -1);
    }
  }, dependencies: [
    FormsModule,
    NgTemplateOutlet
...
(() => {
  ...
  `, imports: [
    ...
    ], styles: ["/* angular:styles/component:scss;768088017cac9104c1d174fa3bd42735246866590373fc167ee01af7b6138b15;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/features/controls/form/input.component.ts */\n:host {\n  display: flex;\n  flex: 1;\n}\n:host.focused {\n  box-shadow: var(--focus-shadow);\n  border-radius: 12px;\n}\n.lg-input {\n  display: flex;\n  flex: 1;\n  background-color: var(--control-bg);\n  border-radius: 12px;\n  gap: 16px;\n}\n.lg-input__after {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  padding: 0 16px;\n  white-space: nowrap;\n  flex: 0 0 auto;\n}\n.lg-input__before {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  padding: 0 16px;\n  white-space: nowrap;\n  flex: 0 0 auto;\n}\n.lg-input__clear {\n  color: #999;\n  font-size: 18px;\n  line-height: 1;\n  font-family: inherit;\n  padding: 0;\n  border: none;\n  appearance: none;\n  background-color: transparent;\n  margin-right: 16px;\n}\n.input {\n  flex: 1;\n  border: none;\n  padding: 16px;\n  border-radius: 12px;\n  font-family: inherit;\n  font-size: inherit;\n  background-color: transparent;\n  width: 100%;\n}\n.input::placeholder {\n  color: var(--placeholder);\n}\n.input:focus {\n  outline: none;\n}\n/*# sourceMappingURL=input.component.css.map */\n"] }]
  }], () => [], { input: [{
    type: ViewChild,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InputComponent, { className: "InputComponent", filePath: "src/app/features/controls/form/input.component.ts", lineNumber: 139 });
})();

export {
  InputComponent
};
//# sourceMappingURL=chunk-4HMEH4DJ.js.map
