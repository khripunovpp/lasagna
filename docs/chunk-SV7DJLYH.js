...
function InvoicesListComponent_For_8_For_5_ng_template_0_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
...
function InvoicesListComponent_For_8_For_5_ng_template_0_Conditional_8_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
  }
...
function InvoicesListComponent_For_8_For_5_ng_template_0_Conditional_8_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function InvoicesListComponent_For_8_For_5_ng_template_0_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275conditionalCreate(3, InvoicesListComponent_For_8_For_5_ng_template_0_Conditional_8_Conditional_3_Template, 2, 3)(4, InvoicesListComponent_For_8_For_5_ng_template_0_Conditional_8_Conditional_4_Template, 1, 1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const invoice_r5 = \u0275\u0275nextContext(2).$implicit;
...
function InvoicesListComponent_For_8_For_5_ng_template_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(7, InvoicesListComponent_For_8_For_5_ng_template_0_Conditional_7_Template, 4, 7, "div");
    \u0275\u0275conditionalCreate(8, InvoicesListComponent_For_8_For_5_ng_template_0_Conditional_8_Template, 5, 4, "div");
  ...
  if (rf & 2) {
    ...
    const \u0275$index_26_r7 = ctx_r5.$index;
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", (tmp_27_0 = ctx_r1.stateBadgeClasses()) == null ? null : tmp_27_0[\u0275$index_19_r8] == null ? null : tmp_27_0[\u0275$index_19_r8][\u0275$index_26_r7]);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", (tmp_28_0 = ctx_r1.stateLabels()) == null ? null : tmp_28_0[\u0275$index_19_r8] == null ? null : tmp_28_0[\u0275$index_19_r8][\u0275$index_26_r7], " ");
    \u0275\u0275advance();
    \u0275\u0275property("mobileMode", true)("left", true);
    \u0275\u0275advance();
...
function InvoicesListComponent_For_8_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, InvoicesListComponent_For_8_For_5_ng_template_0_Template, 14, 22, "ng-template", 6);
  }
  if (rf & 2) {
...
function InvoicesListComponent_For_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, InvoicesListComponent_For_8_For_5_Template, 1, 2, null, 6, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var InvoicesListComponent = class _InvoicesListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InvoicesListComponent, selectors: [["lg-invoices-list"]], features: [\u0275\u0275ProvidersFeature([
    SelectionZoneService,
    CurrencyPipe
  ])], decls: 10, vars: 6, consts: [[3, "selectionTypes"], ["position", "center", "size", "medium"], [3, "click", "icon", "size"], ["aria-hidden", "false", "fontIcon", "add"], [3, "level"], [3, "onSelected", "onDeleteOne", "mode", "selectAll", "deselectAll"], ["lgCardListItem", "", "type", "invoice", 3, "uuid", "bgColor"], ["size", "medium"], ["size", "small", 3, "mobileMode", "left"], ["lgExpand", "", 3, "routerLink"], [3, "ngClass"], ["lgPull", "", 1, "text-muted", "text-cursive"], [3, "click", "size"]], template: function InvoicesListComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InvoicesListComponent, { className: "InvoicesListComponent", filePath: "src/app/features/invoices/view/list/invoices-list.component.ts", lineNumber: 162 });
})();
export {
  InvoicesListComponent
};
//# sourceMappingURL=chunk-SV7DJLYH.js.map
