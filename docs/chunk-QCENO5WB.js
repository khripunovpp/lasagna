import {
  TabDirective,
  TabsComponent
} from "./chunk-TQUR4CUC.js";
import {
  GroupSortService
} from "./chunk-L6UL4XVN.js";
import {
  GroupingHeaderDirective,
  GroupingTileDirective,
  GroupingTilesComponent,
  UploadComponent
} from "./chunk-JU2B3WMH.js";
import {
  CardListComponent,
...
function CategoryListComponent_For_9_ng_template_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-flex-row", 2)(1, "div", 3);
...
function CategoryListComponent_For_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, CategoryListComponent_For_9_ng_template_0_Template, 5, 6, "ng-template", 1);
  }
}
var CategoryListComponent = class _CategoryListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CategoryListComponent, selectors: [["lg-category-list"]], outputs: { onEdit: "onEdit" }, decls: 10, vars: 7, consts: [[3, "size"], ["lgCardListItem", ""], [3, "center"], ["lgExpand", "", 2, "cursor", "pointer", 3, "click"], [3, "click", "size", "icon"], ["aria-hidden", "false", "aria-label", "Delete", "fontIcon", "close"]], template: function CategoryListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-fade-in")(1, "lg-flex-column", 0)(2, "div");
      \u0275\u0275text(3);
      \u0275\u0275pipe(4, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "lg-card-list");
      \u0275\u0275declareLet(6);
      \u0275\u0275pipe(7, "async");
      \u0275\u0275repeaterCreate(8, CategoryListComponent_For_9_Template, 1, 0, null, 1, \u0275\u0275repeaterTrackByIndex);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
function CategoryRecipeListComponent_For_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, CategoryRecipeListComponent_For_9_ng_template_0_Template, 5, 6, "ng-template", 1);
  }
}
var CategoryRecipeListComponent = class _CategoryRecipeListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CategoryRecipeListComponent, selectors: [["lg-category-recipe-list"]], outputs: { onEdit: "onEdit" }, decls: 10, vars: 7, consts: [[3, "size"], ["lgCardListItem", ""], [3, "center"], ["lgExpand", "", 2, "cursor", "pointer", 3, "click"], [3, "click", "size", "icon"], ["aria-hidden", "false", "aria-label", "Delete", "fontIcon", "close"]], template: function CategoryRecipeListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275declareLet(6);
      \u0275\u0275pipe(7, "async");
      \u0275\u0275repeaterCreate(8, CategoryRecipeListComponent_For_9_Template, 1, 0, null, 1, \u0275\u0275repeaterTrackByIndex);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
var AddCategoryFormComponent = class _AddCategoryFormComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddCategoryFormComponent, selectors: [["lg-add-category-form"]], inputs: { uuid: [1, "uuid"] }, outputs: { onSaved: "onSaved" }, decls: 13, vars: 11, consts: [[3, "size"], [3, "formGroup"], [3, "bottom", "mobileMode"], ["lgExpand", ""], ["formControlName", "name", 3, "onEnter", "placeholder"], ["lgNoWrap", ""], [3, "disabled", "style"], [3, "click", "disabled"]], template: function AddCategoryFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-fade-in")(1, "lg-flex-column", 0)(2, "div");
      \u0275\u0275text(3);
      \u0275\u0275pipe(4, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "form", 1)(6, "lg-flex-row", 2)(7, "lg-control", 3)(8, "lg-input", 4);
      \u0275\u0275pipe(9, "translate");
      ...
      \u0275\u0275conditionalCreate(11, AddCategoryFormComponent_Conditional_11_Template, 3, 4, "lg-button", 6)(12, AddCategoryFormComponent_Conditional_12_Template, 3, 4, "lg-button", 6);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275property("size", "medium");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 7, "categories.add-recipe"));
      \u0275\u0275advance(2);
      \u0275\u0275property("formGroup", ctx.form);
      \u0275\u0275advance();
      \u0275\u0275property("bottom", true)("mobileMode", true);
      \u0275\u0275advance(2);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(9, 9, "settings.category.placeholder"));
      \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddCategoryFormComponent, { className: "AddCategoryFormComponent", filePath: "src/app/features/settings/view/categories/category-product/add-category/add-category-form.component.ts", lineNumber: 82 });
})();
...
var AddCategoryRecipeFormComponent = class _AddCategoryRecipeFormComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddCategoryRecipeFormComponent, selectors: [["lg-add-category-recipe-form"]], inputs: { uuid: [1, "uuid"] }, outputs: { onSaved: "onSaved" }, decls: 13, vars: 11, consts: [[3, "size"], [3, "formGroup"], [3, "bottom", "mobileMode"], ["lgExpand", ""], ["formControlName", "name", 3, "onEnter", "placeholder"], ["lgNoWrap", ""], [3, "disabled", "style"], [3, "click", "disabled"]], template: function AddCategoryRecipeFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-fade-in")(1, "lg-flex-column", 0)(2, "div");
      \u0275\u0275text(3);
      \u0275\u0275pipe(4, "translate");
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(10, "div", 5);
      \u0275\u0275conditionalCreate(11, AddCategoryRecipeFormComponent_Conditional_11_Template, 3, 4, "lg-button", 6)(12, AddCategoryRecipeFormComponent_Conditional_12_Template, 3, 4, "lg-button", 6);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275property("size", "medium");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 7, "categories.add-product"));
      \u0275\u0275advance(2);
      \u0275\u0275property("formGroup", ctx.form);
      \u0275\u0275advance();
      \u0275\u0275property("bottom", true)("mobileMode", true);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddCategoryRecipeFormComponent, { className: "AddCategoryRecipeFormComponent", filePath: "src/app/features/settings/view/categories/category-recipe/add-category/add-category-recipe-form.component.ts", lineNumber: 85 });
})();
...
//# sourceMappingURL=chunk-QCENO5WB.js.map
