import {
  TabDirective,
  TabsComponent
} from "./chunk-CG53KIO4.js";
import {
  ControlBoxComponent,
  SelfCenterDirective,
  SelfEndDirective,
  TaxesSettingsComponent
} from "./chunk-ZFOL4VYM.js";
import {
  matchMediaSignal,
  mobileBreakpoint
} from "./chunk-YIUZO3M7.js";
import "./chunk-KYBKLXGS.js";
import {
  WidthDirective
...
} from "./chunk-POZ7R7WF.js";
import {
  UploadComponent
} from "./chunk-3LSKCD37.js";
import "./chunk-I2GJGW5L.js";
import "./chunk-VEVUUZTK.js";
import {
...
(() => {
  ...
  `, encapsulation: ViewEncapsulation.None, providers: [
      ...
      FormsModule,
      NgClass
    ], styles: ["/* angular:styles/component:scss;855696940d7692094d119f28a47304f42366845cf9b16d1afdc08d9c6e266570;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/form/radio.component.ts */\n.lg-radio {\n  display: flex;\n  align-items: center;\n  border-radius: 12px;\n  gap: 8px;\n}\n.lg-radio:focus-within {\n  outline-color: var(--active-color);\n}\n.lg-radio__mark {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 51px;\n  height: 51px;\n  border-radius: 12px;\n  background-color: var(--control-bg);\n  opacity: 0.2;\n  cursor: pointer;\n  transition: all 0.2s ease-in-out;\n  border: 1px solid transparent;\n}\n.lg-radio__hoverOnly {\n  background-color: transparent;\n  border-color: var(--text-color);\n}\n.lg-radio__hoverOnly .lg-radio__mark-inner {\n  opacity: 0;\n  transition: all 0.2s ease-in-out;\n}\n@media (hover: hover) {\n  .lg-radio__mark:hover {\n    opacity: 1;\n  }\n  .lg-radio__hoverOnly:hover .lg-radio__mark-inner {\n    opacity: 1;\n  }\n}\n.checkbox {\n  display: none;\n}\n.checkbox:checked + .lg-radio__mark {\n  background-color: var(--control-bg-selected);\n  opacity: 1;\n  font-weight: 700;\n}\n.checkbox:checked + .lg-radio__hoverOnly {\n  border-color: var(--control-bg-selected);\n}\n.checkbox:checked + .lg-radio__hoverOnly .lg-radio__mark-inner {\n  opacity: 1;\n}\n.lg-radio.small .lg-radio__mark {\n  width: 16px;\n  height: 16px;\n  border-radius: 6px;\n}\n/*# sourceMappingURL=radio.component.css.map */\n"] }]
  }], () => [], { onKeydown: [{
    type: HostListener,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RadioComponent, { className: "RadioComponent", filePath: "src/app/shared/view/ui/form/radio.component.ts", lineNumber: 128 });
})();

// src/app/shared/view/ui/form/currency-select.component.ts
var CurrencySelectComponent = class _CurrencySelectComponent {
  ...
  static \u0275fac = function CurrencySelectComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CurrencySelectComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CurrencySelectComponent, selectors: [["lg-currency-select"]], inputs: { lang: [1, "lang"], selectedCurrency: [1, "selectedCurrency"] }, outputs: { selectedCurrency: "selectedCurrencyChange" }, features: [\u0275\u0275ProvidersFeature([
    ...
    if (rf & 1) {
      ...
      \u0275\u0275pipe(1, "translate");
      \u0275\u0275elementStart(2, "lg-multiselect", 1);
      \u0275\u0275pipe(3, "translate");
      \u0275\u0275listener("onSelected", function CurrencySelectComponent_Template_lg_multiselect_onSelected_2_listener($event) {
        return ctx.onCurrencySelected($event);
      });
      \u0275\u0275twoWayListener("ngModelChange", function CurrencySelectComponent_Template_lg_multiselect_ngModelChange_2_listener($event) {
    ...
    if (rf & 2) {
      \u0275\u0275property("label", \u0275\u0275pipeBind1(1, 5, "language.settings.currency-title"));
      \u0275\u0275advance(2);
      \u0275\u0275twoWayProperty("ngModel", ctx.selectedCurrency);
      \u0275\u0275property("multi", false)("placeholder", \u0275\u0275pipeBind1(3, 7, "currency.select-placeholder"))("staticItems", ctx.displayedCurrencies());
    }
  }, dependencies: [
    CommonModule,
    ReactiveFormsModule,
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:scss;9a0a21e90ab79c284c79806976fd6bae326f23d0aeabbae960b7b6c7d84c43d4;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/form/currency-select.component.ts */\n:host {\n  display: flex;\n  flex: 1;\n}\n/*# sourceMappingURL=currency-select.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CurrencySelectComponent, { className: "CurrencySelectComponent", filePath: "src/app/shared/view/ui/form/currency-select.component.ts", lineNumber: 75 });
})();
...
function LocalisationSettingsComponent_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "lg-flex-row", 4)(1, "lg-radio", 6);
    \u0275\u0275listener("change", function LocalisationSettingsComponent_For_6_Template_lg_radio_change_1_listener() {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("markOnHover", true)("radio", true)("name", "lang")("value", lang_r2.code)("ngModel", ctx_r2.selectedLangModel()[\u0275$index_10_r4])("size", "small")("noMark", true);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 11, lang_r2.name), " ");
  }
}
var LocalisationSettingsComponent = class _LocalisationSettingsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LocalisationSettingsComponent, selectors: [["lg-language-settings"]], inputs: { currency: [1, "currency"], selectedLangModel: [1, "selectedLangModel"] }, outputs: { currency: "currencyChange", selectedLangModel: "selectedLangModelChange" }, decls: 8, vars: 6, consts: [["size", "medium"], [3, "label"], [1, "language-settings"], [3, "size"], [3, "center", "mobileMode", "size"], [3, "ngModelChange", "lang", "ngModel"], ["lgSelfStart", "", 3, "change", "markOnHover", "radio", "name", "value", "ngModel", "size", "noMark"]], template: function LocalisationSettingsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-flex-column", 0)(1, "lg-control", 1);
      \u0275\u0275pipe(2, "translate");
      \u0275\u0275elementStart(3, "section", 2)(4, "lg-flex-column", 3);
      \u0275\u0275repeaterCreate(5, LocalisationSettingsComponent_For_6_Template, 4, 13, "lg-flex-row", 4, _forTrack0);
      \u0275\u0275elementEnd()()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LocalisationSettingsComponent, { className: "LocalisationSettingsComponent", filePath: "src/app/features/settings/view/localisation/localisation-settings.component.ts", lineNumber: 64 });
})();
...
var BackupSettingsComponent = class _BackupSettingsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BackupSettingsComponent, selectors: [["lg-backup-settings"]], decls: 23, vars: 27, consts: [[3, "center", "mobileMode"], ["lgSelfStart", "", 3, "click"], [3, "filesSelected", "accept"], [2, "--card-bg", "#e78888"], [3, "position"], [1, "text-center", "text-inverse"], [2, "--card-bg", "#fcd9b5"], [1, "text-center"], [3, "click"]], template: function BackupSettingsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementStart(7, "lg-card", 3)(8, "lg-flex-column", 4)(9, "div", 5);
      \u0275\u0275text(10);
      \u0275\u0275pipe(11, "translate");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(14, "translate");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(15, "lg-card", 6)(16, "lg-flex-column", 4)(17, "div", 7);
      \u0275\u0275text(18);
      \u0275\u0275pipe(19, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(20, "lg-button", 8);
      \u0275\u0275listener("click", function BackupSettingsComponent_Template_lg_button_click_20_listener() {
        return ctx.onFlush();
      });
      \u0275\u0275text(21);
      \u0275\u0275pipe(22, "translate");
    ...
    if (rf & 2) {
      ...
      \u0275\u0275styleMap("success");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 17, "backup.make-btn"), " ");
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 19, "backup.restore-informer"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275styleMap("danger");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(14, 21, "backup.restore-btn"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("position", "center");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(19, 23, "backup.flush-informer"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275styleMap("success");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(22, 25, "backup.flush-btn"), " ");
    }
  }, dependencies: [
    CardComponent,
    FlexRowComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BackupSettingsComponent, { className: "BackupSettingsComponent", filePath: "src/app/features/settings/view/backup/backup-settings.component.ts", lineNumber: 73 });
})();
...
var _c1 = [[["after"]]];
var _c2 = ["after"];
function FileInputComponent_span_8_Template(rf, ctx) {
  if (rf & 1) {
...
var FileInputComponent = class _FileInputComponent {
  ...
  // стиль lg-button
  buttonText = input("file-input.upload-file");
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FileInputComponent, selectors: [["lg-file-input"]], viewQuery: function FileInputComponent_Query(rf, ctx) {
    ...
    multi: true
  }])], ngContentSelectors: _c2, decls: 9, vars: 14, consts: [["fileInput", ""], [1, "lg-file-input"], ["type", "file", 1, "hidden-input", 3, "change", "disabled"], ["size", "small", 3, "onClick", "disabled"], [1, "lg-file-input__after"], ["class", "error-message", 4, "ngIf"], [1, "error-message"]], template: function FileInputComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275projectionDef(_c1);
      ...
      \u0275\u0275projection(7);
      \u0275\u0275template(8, FileInputComponent_span_8_Template, 2, 1, "span", 5);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FileInputComponent, { className: "FileInputComponent", filePath: "src/app/shared/view/ui/form/file-input.component.ts", lineNumber: 73 });
})();

// src/app/features/settings/view/finance-settings/invoices-settings/invoices-settings.component.ts
function InvoicesSettingsComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
var InvoicesSettingsComponent = class _InvoicesSettingsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InvoicesSettingsComponent, selectors: [["lg-invoices-settings"]], decls: 29, vars: 30, consts: [[3, "formGroup"], ["size", "medium"], [3, "level"], [1, "lg-invoices-settings__logo"], ["formControlName", "logo", 3, "buttonStyle", "buttonText"], ["formControlName", "prefix"], ["size", "small"], [3, "flat", "level"], ["formControlName", "precisionRows"], ["formControlName", "precisionTotals"], ["alt", "Logo", 3, "src"]], template: function InvoicesSettingsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-flex-column", 0)(1, "lg-flex-column", 1)(2, "lg-title", 2);
      \u0275\u0275text(3);
      \u0275\u0275pipe(4, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(5, InvoicesSettingsComponent_Conditional_5_Template, 2, 1, "div", 3);
      \u0275\u0275element(6, "lg-file-input", 4);
      \u0275\u0275pipe(7, "translate");
      \u0275\u0275pipe(8, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "lg-flex-column", 1)(10, "lg-title", 2);
      \u0275\u0275text(11);
      \u0275\u0275pipe(12, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275element(13, "lg-input", 5);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "lg-flex-column", 1)(15, "lg-title", 2);
      \u0275\u0275text(16);
      \u0275\u0275pipe(17, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "lg-flex-row")(19, "lg-flex-column", 6)(20, "lg-title", 7);
      \u0275\u0275text(21);
      \u0275\u0275pipe(22, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275element(23, "lg-number-input", 8);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "lg-flex-column", 6)(25, "lg-title", 7);
      \u0275\u0275text(26);
      \u0275\u0275pipe(27, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275element(28, "lg-number-input", 9);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275property("level", 5);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 16, "settings.invoices.logo"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.logoBase64() ? 5 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("buttonStyle", ctx.logoBase64() ? "danger" : "default")("buttonText", ctx.logoBase64() ? \u0275\u0275pipeBind1(7, 18, "settings.invoices.replace-logo") : \u0275\u0275pipeBind1(8, 20, "settings.invoices.upload-logo"));
      \u0275\u0275advance(4);
      \u0275\u0275property("level", 5);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 22, "settings.invoices.prefix"), " ");
      \u0275\u0275advance(4);
      \u0275\u0275property("level", 5);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(17, 24, "settings.invoices.precision"), " ");
      \u0275\u0275advance(4);
      \u0275\u0275property("flat", true)("level", 6);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(22, 26, "settings.invoices.precision-rows"), " ");
      \u0275\u0275advance(4);
      \u0275\u0275property("flat", true)("level", 6);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(27, 28, "settings.invoices.precision-totals"), " ");
    }
  }, dependencies: [
    FlexColumnComponent,
    InputComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InvoicesSettingsComponent, { className: "InvoicesSettingsComponent", filePath: "src/app/features/settings/view/finance-settings/invoices-settings/invoices-settings.component.ts", lineNumber: 96 });
})();
...
function CreateCredentialComponent_For_4_Conditional_1_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
...
function CreateCredentialComponent_For_4_ng_template_3_Conditional_27_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(1, 1, "settings.credentials.delete-row"), " ");
  }
}
...
function CreateCredentialComponent_For_4_ng_template_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("label", \u0275\u0275pipeBind1(3, 19, "settings.credentials.private-name"));
    \u0275\u0275advance(3);
    \u0275\u0275property("equal", true)("mobileMode", true);
    \u0275\u0275advance();
    \u0275\u0275property("label", \u0275\u0275pipeBind1(7, 21, "settings.credentials.name"));
    \u0275\u0275advance(3);
    \u0275\u0275property("label", \u0275\u0275pipeBind1(10, 23, "settings.credentials.tax-id"));
    \u0275\u0275advance(3);
    \u0275\u0275property("equal", true)("mobileMode", true);
    \u0275\u0275advance();
    \u0275\u0275property("label", \u0275\u0275pipeBind1(14, 25, "settings.credentials.country"));
    \u0275\u0275advance(3);
    \u0275\u0275property("label", \u0275\u0275pipeBind1(17, 27, "settings.credentials.address"));
    \u0275\u0275advance(3);
    \u0275\u0275property("equal", true)("mobileMode", true);
    \u0275\u0275advance();
    \u0275\u0275property("label", \u0275\u0275pipeBind1(21, 29, "settings.credentials.phone"));
    \u0275\u0275advance(3);
...
function CredentialSettingsComponent_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "lg-create-credential", 3);
  }
  if (rf & 2) {
...
var CredentialSettingsComponent = class _CredentialSettingsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CredentialSettingsComponent, selectors: [["lg-credentials-settings"]], decls: 5, vars: 8, consts: [[3, "flat", "silent"], ["alias", "system", "lgTab", "", 3, "label"], ["alias", "customers", "lgTab", "", 3, "label"], [3, "type"]], template: function CredentialSettingsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-tabs", 0);
      \u0275\u0275template(1, CredentialSettingsComponent_ng_template_1_Template, 1, 1, "ng-template", 1);
      \u0275\u0275pipe(2, "translate");
      \u0275\u0275template(3, CredentialSettingsComponent_ng_template_3_Template, 1, 1, "ng-template", 2);
      \u0275\u0275pipe(4, "translate");
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("label", \u0275\u0275pipeBind1(2, 4, "settings.credentials.system"));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(4, 6, "settings.credentials.customer"));
    }
  }, dependencies: [
    TabsComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CredentialSettingsComponent, { className: "CredentialSettingsComponent", filePath: "src/app/features/settings/view/finance-settings/credentials/credential-settings.component.ts", lineNumber: 32 });
})();
...
var PaginationService = class _PaginationService {
  ...
  _itemsPerPage = signal(20);
  // Computed values
  totalItems = computed(() => this._items().length);
  totalPages = computed(() => Math.ceil(this.totalItems() / this._itemsPerPage()));
...
var LogCenterComponent = class _LogCenterComponent {
  ...
  logs = signal([]);
  paginatedLogs = signal([]);
  groupedLogs = signal(null);
  stats = signal({
    total: 0,
...
function SettingsComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-flex-row", 7)(1, "a", 8);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
...
function SettingsComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
...
var SettingsComponent = class _SettingsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SettingsComponent, selectors: [["lg-settings"]], decls: 20, vars: 28, consts: [["alias", "language", "lgTab", "", 3, "label"], ["alias", "categoires", "lgTab", "", 3, "label"], ["alias", "invoice", "lgTab", "", 3, "label"], ["alias", "credentials", "lgTab", "", 3, "label"], ["alias", "taxes", "lgTab", "", 3, "label"], ["alias", "backup", "lgTab", "", 3, "label"], ["alias", "logs", "lgTab", "", 3, "label"], [3, "mobileMode", "top"], ["lgExpand", "", "routerLink", "/settings/categories/products", "routerLinkActive", "active"], ["lgExpand", "", "routerLink", "/settings/categories/recipes", "routerLinkActive", "active"]], template: function SettingsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(15, "translate");
      \u0275\u0275template(16, SettingsComponent_ng_template_16_Template, 1, 0, "ng-template", 5);
      \u0275\u0275pipe(17, "translate");
      \u0275\u0275template(18, SettingsComponent_ng_template_18_Template, 1, 0, "ng-template", 6);
      \u0275\u0275pipe(19, "translate");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 12, "settings.title"));
      \u0275\u0275advance(3);
      \u0275\u0275property("label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(7, 14, "language.settings-title")));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(9, 16, "categories.settings-title")));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(11, 18, "settings.invoice.title"));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(13, 20, "settings.credentials.title"));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(15, 22, "settings.taxes.title"));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(17, 24, "backup.settings-title")));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(19, 26, "log-center.title")));
    }
  }, dependencies: [
    ContainerComponent,
    FlexRowComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SettingsComponent, { className: "SettingsComponent", filePath: "src/app/features/settings/view/settings.component.ts", lineNumber: 45 });
})();
export {
  SettingsComponent
};
//# sourceMappingURL=chunk-CTARJ7US.js.map
