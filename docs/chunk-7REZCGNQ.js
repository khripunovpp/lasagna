...
(function(Stores2) {
  ...
  Stores2["CHANGES_LOG"] = "changes_log";
})(Stores || (Stores = {}));
...
// src/app/shared/view/const/units.const.ts
var UnitValue = {
  GRAM: "gram",
  KILOGRAM: "kilogram",
  PIECE: "piece"
...
var DexieIndexDbService = class _DexieIndexDbService extends import_wrapper_default {
  ...
  async balkAdd(storeKey, values, autoUUID = true) {
    ...
    const resp = await this[storeKey].bulkPut(valuesWithUuid, { allKeys: true });
    if (storeKey === Stores.INDICES) {
      return resp;
    }
...
dexie/dist/dexie.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-7REZCGNQ.js.map
