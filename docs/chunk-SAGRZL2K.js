...
(() => {
  ...
  }], () => [], { closeButton: [{ type: Input, args: [{ isSignal: true, alias: "closeButton", required: false }] }], cancelButtonText: [{ type: Input, args: [{ isSignal: true, alias: "cancelButtonText", required: false }] }], confirmButtonText: [{ type: Input, args: [{ isSignal: true, alias: "confirmButtonText", required: false }] }], confirmButtonStyle: [{ type: Input, args: [{ isSignal: true, alias: "confirmButtonStyle", required: false }] }], cancelButtonStyle: [{ type: Input, args: [{ isSignal: true, alias: "cancelButtonStyle", required: false }] }], closeOnConfirm: [{ type: Input, args: [{ isSignal: true, alias: "closeOnConfirm", required: false }] }], displayFooter: [{ type: Input, args: [{ isSignal: true, alias: "displayFooter", required: false }] }], centerButtons: [{ type: Input, args: [{ isSignal: true, alias: "centerButtons", required: false }] }], columnButtons: [{ type: Input, args: [{ isSignal: true, alias: "columnButtons", required: false }] }], showConfirmButton: [{ type: Input, args: [{ isSignal: true, alias: "showConfirmButton", required: false }] }], onCancel: [{ type: Output, args: ["onCancel"] }], onConfirm: [{ type: Output, args: ["onConfirm"] }] });
})();
(() => {
...
//# sourceMappingURL=chunk-SAGRZL2K.js.map
