...
import "./chunk-TZO5KX4G.js";
import {
  DocsService
} from "./chunk-HRKLZBBB.js";
import {
  ButtonComponent,
  TranslatePipe
...
// src/app/shared/view/documentation/docs-three.component.ts
...
(() => {
  ...
  `, imports: [
      ...
      MatIcon,
      TranslatePipe
    ], styles: ["/* angular:styles/component:scss;c7bd6d79526e8fad77ddcb9a77b0c738aca181662f174ab68031fcce754fa795;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/documentation/docs-three.component.ts */\n.lg-documentation-container {\n  font-size: 14px;\n  line-height: 1.5;\n}\n.doc-tree-item {\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  cursor: pointer;\n  -webkit-user-select: none;\n  user-select: none;\n  padding: 2px 0;\n  white-space: nowrap;\n}\n.doc-tree-toggle {\n  width: 16px;\n  display: inline-block;\n  cursor: pointer;\n  font-size: 12px;\n}\n.doc-tree-empty-icon {\n  width: 16px;\n  display: inline-block;\n}\n.doc-tree-link {\n  color: #2a2a2a;\n  text-decoration: none;\n  transition: color 0.2s;\n}\n.doc-tree-link:hover {\n  text-decoration: underline;\n  color: #000;\n}\n.doc-tree-folder-name {\n  font-weight: 600;\n}\n/*# sourceMappingURL=docs-three.component.css.map */\n"] }]
  }], () => [{ type: DocsService }, { type: Router }, { type: Renderer2 }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DocsThreeComponent, { className: "DocsThreeComponent", filePath: "src/app/shared/view/documentation/docs-three.component.ts", lineNumber: 123 });
})();

// src/app/shared/view/documentation/documentation-container.component.ts
var DocumentationContainerComponent = class _DocumentationContainerComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DocumentationContainerComponent, selectors: [["lg-documentation-container"]], hostAttrs: [1, "lg-documentation-container"], decls: 4, vars: 1, consts: [[3, "compact"], [1, "lg-documentation-container__content"]], template: function DocumentationContainerComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-container", 0);
      \u0275\u0275element(1, "lg-docs-three");
    ...
    ContainerComponent,
    DocsThreeComponent
  ], styles: ["\n\n.lg-documentation-container__content[_ngcontent-%COMP%] {\n  margin-top: 32px;\n}\n@media (max-width: 768px) {\n  .lg-documentation-container__content[_ngcontent-%COMP%] {\n    margin-top: 8px;\n  }\n}\n/*# sourceMappingURL=documentation-container.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DocumentationContainerComponent, [{
    type: Component,
  ...
  `, host: {
      ...
      ContainerComponent,
      DocsThreeComponent
    ], styles: ["/* angular:styles/component:scss;39dc75335cf90cd3e7b26029340ab752a1f45ffca05342810e91d709dc3ec340;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/documentation/documentation-container.component.ts */\n.lg-documentation-container__content {\n  margin-top: 32px;\n}\n@media (max-width: 768px) {\n  .lg-documentation-container__content {\n    margin-top: 8px;\n  }\n}\n/*# sourceMappingURL=documentation-container.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DocumentationContainerComponent, { className: "DocumentationContainerComponent", filePath: "src/app/shared/view/documentation/documentation-container.component.ts", lineNumber: 38 });
})();
export {
  DocumentationContainerComponent
};
//# sourceMappingURL=chunk-MUQN6PG3.js.map
