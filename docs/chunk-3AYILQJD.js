...
var TitleComponent = class _TitleComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TitleComponent, selectors: [["lg-title"]], inputs: { level: [1, "level"], flat: [1, "flat"] }, ngContentSelectors: _c0, decls: 2, vars: 5, consts: [["role", "heading", 1, "title", 3, "ngClass", "aria-level"]], template: function TitleComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275ariaProperty("aria-level", \u0275\u0275interpolate(ctx.level()));
...
(() => {
  ...
  }], null, { level: [{ type: Input, args: [{ isSignal: true, alias: "level", required: false }] }], flat: [{ type: Input, args: [{ isSignal: true, alias: "flat", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TitleComponent, { className: "TitleComponent", filePath: "src/app/shared/view/layout/title.component.ts", lineNumber: 54 });
})();

export {
  TitleComponent
};
//# sourceMappingURL=chunk-3AYILQJD.js.map
