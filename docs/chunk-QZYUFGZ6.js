...
(() => {
  ...
  }], control: [{ type: Input, args: [{ isSignal: true, alias: "control", required: false }] }], items: [{
    type: Input
  }] });
})();
(() => {
...
// src/app/shared/view/ui/html-editor/html-editor.component.ts
var HtmlEditorComponent_Defer_2_DepsFn = () => [
  NgxEditorMenuComponent,
  NgxEditorComponent,
  NgControlStatus,
  FormControlDirective
];
function HtmlEditorComponent_Defer_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ngx-editor-menu", 0)(1, "ngx-editor", 1);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("editor", ctx_r0.editor)("toolbar", ctx_r0.toolbar);
    \u0275\u0275advance();
    \u0275\u0275property("disabled", false)("editor", ctx_r0.editor)("formControl", ctx_r0.htmlString)("placeholder", ctx_r0.placeholder());
  }
}
function HtmlEditorComponent_DeferError_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
  }
  if (rf & 2) {
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(1, 1, "html-editor.defer-load-error"), " ");
  }
}
var HtmlEditorComponent = class _HtmlEditorComponent {
  constructor() {
  }
  ...
  ngOnInit() {
    this.htmlString.valueChanges.pipe(takeUntilDestroyed(this._destroyRef)).subscribe((value) => {
      this.onChange(value ?? "");
    });
  }
  ngOnDestroy() {
  ...
  static \u0275fac = function HtmlEditorComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _HtmlEditorComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HtmlEditorComponent, selectors: [["lg-html-editor"]], inputs: { placeholder: [1, "placeholder"] }, features: [\u0275\u0275ProvidersFeature([
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: _HtmlEditorComponent,
      multi: true
    }
  ])], decls: 4, vars: 0, consts: [[3, "editor", "toolbar"], [3, "disabled", "editor", "formControl", "placeholder"]], template: function HtmlEditorComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275domTemplate(0, HtmlEditorComponent_Defer_0_Template, 2, 6)(1, HtmlEditorComponent_DeferError_1_Template, 2, 3);
      \u0275\u0275defer(2, 0, HtmlEditorComponent_Defer_2_DepsFn, null, null, 1);
      \u0275\u0275deferOnIdle();
    }
  }, dependencies: [
    FormsModule,
    ReactiveFormsModule,
    TranslatePipe
  ], styles: ["/* angular:styles/component:scss;d5d9982e73e51d03236609ec25edd29dba518cb32dd3810f8e9c7a0096e22a03;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/html-editor/html-editor.component.ts */\nlg-html-editor {\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n}\n.html-editor {\n  width: 100%;\n  height: 200px;\n  margin-bottom: 10px;\n  font-family: monospace;\n}\n.preview {\n  border: 1px solid #ccc;\n  padding: 10px;\n  min-height: 200px;\n  background-color: #f9f9f9;\n}\n.NgxEditor {\n  min-height: 200px;\n}\n/*# sourceMappingURL=html-editor.component.css.map */\n"], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HtmlEditorComponent, [{
    type: Component,
    args: [{ selector: "lg-html-editor", encapsulation: ViewEncapsulation.None, template: `
    @defer {
  ...
  }], () => [], { placeholder: [{ type: Input, args: [{ isSignal: true, alias: "placeholder", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HtmlEditorComponent, { className: "HtmlEditorComponent", filePath: "src/app/shared/view/ui/html-editor/html-editor.component.ts", lineNumber: 63 });
})();
...
//# sourceMappingURL=chunk-QZYUFGZ6.js.map
