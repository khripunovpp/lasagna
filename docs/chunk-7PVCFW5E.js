...
(() => {
  ...
  `, encapsulation: ViewEncapsulation.None, providers: [
      ...
      FormsModule,
      NgClass
    ], styles: ["/* angular:styles/component:scss;56f2ee5c1983590cab80b56b24d61195e0ae30402054f4dfeb377ce7c7f63041;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/features/controls/form/chckbox.component.ts */\n.lg-checkbox {\n  display: flex;\n  border-radius: 12px;\n  gap: 8px;\n}\n.lg-checkbox:focus-within {\n  outline-color: var(--active-color);\n}\n.lg-checkbox__mark {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 51px;\n  height: 51px;\n  border-radius: 12px;\n  background-color: var(--control-bg);\n  opacity: 0.5;\n  cursor: pointer;\n  transition: all 0.2s ease-in-out;\n  border: 1px solid transparent;\n}\n.lg-checkbox__mark-inner {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.lg-checkbox__hoverOnly {\n  background-color: transparent;\n  border-color: var(--text-color);\n}\n.lg-checkbox__hoverOnly .lg-checkbox__mark-inner {\n  opacity: 0;\n  transition: all 0.2s ease-in-out;\n}\n@media (hover: hover) {\n  .lg-checkbox__mark:hover {\n    opacity: 1;\n  }\n  .lg-checkbox__hoverOnly:hover .lg-checkbox__mark-inner {\n    opacity: 1;\n  }\n}\n.checkbox {\n  display: none;\n}\n.checkbox:checked + .lg-checkbox__mark {\n  background-color: var(--control-bg-selected);\n  opacity: 1;\n  font-weight: 700;\n}\n.checkbox:checked + .lg-checkbox__hoverOnly {\n  border-color: var(--control-bg-selected);\n}\n.checkbox:checked + .lg-checkbox__hoverOnly .lg-checkbox__mark-inner {\n  opacity: 1;\n}\n.lg-checkbox.small .lg-checkbox__mark {\n  width: 16px;\n  height: 16px;\n  border-radius: 6px;\n}\n.lg-checkbox.medium .lg-checkbox__mark {\n  width: 24px;\n  height: 24px;\n  border-radius: 8px;\n}\n/*# sourceMappingURL=chckbox.component.css.map */\n"] }]
  }], () => [], { value: [{
    type: Input
  }], onKeydown: [{
    type: HostListener,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CheckboxComponent, { className: "CheckboxComponent", filePath: "src/app/features/controls/form/chckbox.component.ts", lineNumber: 137 });
})();

export {
  CheckboxComponent
};
//# sourceMappingURL=chunk-7PVCFW5E.js.map
