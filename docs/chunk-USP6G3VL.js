...
(() => {
  ...
  }], placeholder: [{ type: Input, args: [{ isSignal: true, alias: "placeholder", required: false }] }], autoFocus: [{ type: Input, args: [{ isSignal: true, alias: "autoFocus", required: false }] }], inputType: [{ type: Input, args: [{ isSignal: true, alias: "inputType", required: false }] }], disable: [{ type: Input, args: [{ isSignal: true, alias: "disable", required: false }] }], onInputChanged: [{ type: Output, args: ["onInputChanged"] }], onEnter: [{ type: Output, args: ["onEnter"] }], theme: [{ type: Input, args: [{ isSignal: true, alias: "theme", required: false }] }], size: [{ type: Input, args: [{ isSignal: true, alias: "size", required: false }] }], extraTpl: [{ type: ContentChildren, args: [forwardRef(() => ControlExtraTemplateDirective), __spreadProps(__spreadValues({}, { descendants: true }), { isSignal: true })] }], focusedClass: [{
    type: HostBinding,
    args: ["class.focused"]
  }] });
})();
...
//# sourceMappingURL=chunk-USP6G3VL.js.map
