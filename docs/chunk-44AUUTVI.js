...
(() => {
  ...
  `, imports: [
      ...
      FocusTrapDirective,
      TranslatePipe
    ], styles: ["/* angular:styles/component:scss;2012bd1f188f46381564f0ace813a993f5efede7d25a8a5361dceede7b6cae95;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/dialogs/dialog.component.ts */\n.dialog {\n  display: flex;\n  position: fixed;\n  z-index: 9;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5);\n  justify-content: center;\n  align-items: center;\n  overflow-y: auto;\n}\n.dialog__container {\n  width: clamp(300px, 100%, 800px);\n  height: 100%;\n}\n.dialog__box {\n  width: 100%;\n}\n.dialog__wrap {\n  padding: 32px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n@media (max-width: 658px) {\n  .dialog__wrap {\n    padding: 16px 8px;\n  }\n}\n.dialog__inner-container {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n}\n.dialog__footer {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  border-top: 1px solid #f5f5f5;\n  padding-top: 16px;\n}\n@media (max-width: 658px) {\n  .dialog__footer {\n    flex-direction: column;\n    align-items: flex-start;\n  }\n}\n.dialog__close-button {\n  float: right;\n  appearance: none;\n  border: none;\n  background: #f5f5f5;\n  font-family: inherit;\n  font-size: 16px;\n  line-height: 1;\n  padding: 4px 8px;\n  border-radius: 8px;\n  margin-bottom: 16px;\n  transition: transform 0.2s ease-in-out;\n  cursor: pointer;\n}\n.dialog__close-button:hover {\n  transform: scale(0.9);\n}\n/*# sourceMappingURL=dialog.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DialogComponent, { className: "DialogComponent", filePath: "src/app/shared/view/ui/dialogs/dialog.component.ts", lineNumber: 134 });
})();
...
//# sourceMappingURL=chunk-44AUUTVI.js.map
