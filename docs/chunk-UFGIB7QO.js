...
(() => {
  ...
  }], null, { position: [{ type: Input, args: [{ isSignal: true, alias: "position", required: false }] }] });
})();
...
(() => {
  ...
  }], () => [], { label: [{ type: Input, args: [{ isSignal: true, alias: "label", required: false }] }], flow: [{ type: Input, args: [{ isSignal: true, alias: "flow", required: false }] }], labelFor: [{ type: Input, args: [{ isSignal: true, alias: "labelFor", required: false }] }], labelTpls: [{ type: ContentChildren, args: [forwardRef(() => ControlLabelTemplateDirective), { isSignal: true }] }] });
})();
(() => {
...
//# sourceMappingURL=chunk-UFGIB7QO.js.map
