...
var FaqComponent = class _FaqComponent {
  ...
  localizedFaqs = computed(() => this.faqService.getFaqsView().filter((section) => section.language === this.lang()));
  ...
  }, dependencies: [SafeHtmlPipe, TranslatePipe, TitleComponent], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FaqComponent, [{
    type: Component,
    args: [{ selector: "lg-faq", standalone: true, imports: [SafeHtmlPipe, SafeHtmlPipe, TranslatePipe, SelfStartDirective, TitleComponent], template: `
    <lg-title>
      {{ 'faq.title' | translate }}
    </lg-title>
...
//# sourceMappingURL=chunk-TQUKVKIZ.js.map
