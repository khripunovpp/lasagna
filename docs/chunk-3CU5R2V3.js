...
(() => {
  ...
  `, imports: [
    ...
    ], styles: ['/* angular:styles/component:scss;72890856912d9c103734991845227c7420130f4b0889e6bb27e67e9e3593a254;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/features/controls/form/readonly-control.component.ts */\n:host {\n  display: flex;\n  -webkit-user-select: none;\n  user-select: none;\n  width: 100%;\n}\n.lg-readonly-control {\n  width: 100%;\n  display: flex;\n  border-radius: 12px;\n  gap: 16px;\n  position: relative;\n  opacity: 0.99;\n  border: 1px solid var(--control-bg);\n}\n.lg-readonly-control::after {\n  content: "";\n  position: absolute;\n  z-index: -1;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: var(--control-bg);\n  border-radius: 12px;\n  opacity: 0.4;\n}\n.lg-readonly-control__after {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  padding: 0 16px;\n  white-space: nowrap;\n  flex: 0 0 auto;\n}\n.input {\n  border: none;\n  padding: 15px;\n  border-radius: 12px;\n  font-family: inherit;\n  font-size: inherit;\n  background-color: transparent;\n  width: 100%;\n  pointer-events: none;\n  -webkit-user-select: none;\n  user-select: none;\n}\n.input::placeholder {\n  color: var(--placeholder);\n}\n.input:focus {\n  outline: none;\n  box-shadow: var(--focus-shadow);\n}\n/*# sourceMappingURL=readonly-control.component.css.map */\n'] }]
...
//# sourceMappingURL=chunk-3CU5R2V3.js.map
