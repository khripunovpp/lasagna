...
var ProductListComponent = class _ProductListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductListComponent, selectors: [["lg-product-list"]], features: [\u0275\u0275ProvidersFeature([
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("translateParams", \u0275\u0275pureFunction1(19, _c02, (tmp_3_0 = ctx.products()) == null ? null : tmp_3_0.length))("translate", "filters.results.length");
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductListComponent, { className: "ProductListComponent", filePath: "src/app/features/products/view/list/product-list.component.ts", lineNumber: 192 });
})();
export {
  ProductListComponent
};
//# sourceMappingURL=chunk-25WITDPI.js.map
