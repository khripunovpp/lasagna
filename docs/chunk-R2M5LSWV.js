...
} from "./chunk-VY2OUIQC.js";
import {
  matchMediaSignal,
  mobileBreakpoint
} from "./chunk-XJ6SNI3K.js";
import "./chunk-HWAVWBSU.js";
import {
  GroupSortService
} from "./chunk-XOACDSX6.js";
import {
...
import "./chunk-B4S2BNWI.js";
import {
  GroupingHeaderDirective,
  GroupingTailDirective,
  GroupingTailsComponent
} from "./chunk-BB6GYXW3.js";
import {
  UploadComponent
} from "./chunk-GACK4QYF.js";
import "./chunk-6JSKWGL2.js";
import "./chunk-CBQ3TFJX.js";
import "./chunk-3M33S5ST.js";
import {
  ShrinkDirective
...
function LocalisationSettingsComponent_For_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-flex-row", 4)(1, "lg-radio", 7);
    \u0275\u0275listener("change", function LocalisationSettingsComponent_For_7_Template_lg_radio_change_1_listener() {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("markOnHover", true)("radio", true)("name", "lang")("value", lang_r2.code)("ngModel", ctx_r2.selectedLangModel()[\u0275$index_11_r4])("size", "small")("noMark", true);
    \u0275\u0275advance();
...
var LocalisationSettingsComponent = class _LocalisationSettingsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LocalisationSettingsComponent, selectors: [["lg-language-settings"]], inputs: { currency: [1, "currency"], selectedLangModel: [1, "selectedLangModel"] }, outputs: { currency: "currencyChange", selectedLangModel: "selectedLangModelChange" }, decls: 15, vars: 10, consts: [["size", "medium"], [3, "level"], [1, "language-settings"], [3, "size"], [3, "center", "mobileMode", "size"], ["href", "https://en.wikipedia.org/wiki/ISO_4217", "target", "_blank"], [3, "ngModelChange", "ngModel"], ["lgSelfStart", "", 3, "change", "markOnHover", "radio", "name", "value", "ngModel", "size", "noMark"]], template: function LocalisationSettingsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-flex-column", 0)(1, "lg-title", 1);
      \u0275\u0275text(2);
      \u0275\u0275pipe(3, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "section", 2)(5, "lg-flex-column", 3);
      \u0275\u0275repeaterCreate(6, LocalisationSettingsComponent_For_7_Template, 4, 13, "lg-flex-row", 4, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(8, "lg-title", 1);
      \u0275\u0275text(9);
      \u0275\u0275pipe(10, "translate");
      ...
      \u0275\u0275text(13, ") ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "lg-input", 6);
      \u0275\u0275listener("ngModelChange", function LocalisationSettingsComponent_Template_lg_input_ngModelChange_14_listener($event) {
        return ctx.changeCurrency($event);
      });
      \u0275\u0275twoWayListener("ngModelChange", function LocalisationSettingsComponent_Template_lg_input_ngModelChange_14_listener($event) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("level", 6);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 6, "language.settings.language-title"));
      \u0275\u0275advance(3);
      ...
      \u0275\u0275property("level", 6);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 8, "language.settings.currency-title"), " (");
      \u0275\u0275advance(5);
...
//# sourceMappingURL=chunk-R2M5LSWV.js.map
