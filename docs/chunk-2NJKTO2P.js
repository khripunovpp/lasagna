...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ContainerComponent, [{
    ...
    </section>`, styles: ["/* angular:styles/component:scss;bcf4c1f386517b03fd146acfb19358969312f154c6d5378abb9c7ed04686c406;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/layout/container/container.component.ts */\n:host {\n  display: flex;\n  height: 100%;\n  padding: 0 32px;\n}\n@media (max-width: 768px) {\n  :host {\n    padding: 0 16px;\n  }\n}\n.container {\n  display: flex;\n  flex-direction: column;\n  margin: 0 auto;\n  width: 100%;\n  max-width: var(--container-width);\n  gap: 32px;\n}\n@media (max-width: 768px) {\n  .container {\n    gap: 16px;\n  }\n}\n.container.compact {\n  gap: 0 !important;\n}\n/*# sourceMappingURL=container.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContainerComponent, { className: "ContainerComponent", filePath: "src/app/shared/view/ui/layout/container/container.component.ts", lineNumber: 44 });
})();

export {
  ContainerComponent
};
//# sourceMappingURL=chunk-2NJKTO2P.js.map
