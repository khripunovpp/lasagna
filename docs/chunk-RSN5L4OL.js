...
(() => {
  ...
  }], () => [{ type: DocsService }, { type: Router }, { type: Renderer2 }], { dropdownComponent: [{ type: ViewChild, args: [forwardRef(() => DropdownComponent), { isSignal: true }] }], dropdownElementRef: [{ type: ViewChild, args: [forwardRef(() => DropdownComponent), __spreadProps(__spreadValues({}, { read: ElementRef }), { isSignal: true })] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DocsThreeComponent, { className: "DocsThreeComponent", filePath: "src/app/features/documentation/view/docs-three.component.ts", lineNumber: 125 });
})();
export {
  DocsThreeComponent
};
//# sourceMappingURL=chunk-RSN5L4OL.js.map
