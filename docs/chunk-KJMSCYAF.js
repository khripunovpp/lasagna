...
var LastEditedRecipesComponent = class _LastEditedRecipesComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LastEditedRecipesComponent, selectors: [["lg-last-edited-recipes"]], decls: 8, vars: 6, consts: [["size", "medium"], [3, "level"], [3, "size"], [3, "center", "size", "mobileMode"], [1, "last-edited-recipe-name"], [1, "last-edited-recipe", 3, "routerLink"], ["lgPull", "", 1, "text-muted", "text-cursive"]], template: function LastEditedRecipesComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(5, LastEditedRecipesComponent_For_6_Template, 6, 10, "lg-flex-row", 3, _forTrack0, false, LastEditedRecipesComponent_ForEmpty_7_Template, 3, 3, "div", 4);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
var LastEditedProductsComponent = class _LastEditedProductsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LastEditedProductsComponent, selectors: [["lg-last-edited-products"]], decls: 9, vars: 6, consts: [["size", "medium"], [3, "level"], [1, "last-edited-recipes"], [3, "size"], [3, "center", "size", "mobileMode"], [1, "last-edited-recipe-name"], [1, "last-edited-product", 3, "routerLink"], ["lgPull", "", 1, "text-muted", "text-cursive"]], template: function LastEditedProductsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-flex-column", 0)(1, "lg-title", 1);
      \u0275\u0275text(2);
      \u0275\u0275pipe(3, "translate");
      ...
      \u0275\u0275repeaterCreate(6, LastEditedProductsComponent_For_7_Template, 6, 10, "lg-flex-row", 4, _forTrack02, false, LastEditedProductsComponent_ForEmpty_8_Template, 3, 3, "div", 5);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
function OnboardingComponent_Conditional_0_For_10_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
  }
...
function OnboardingComponent_Conditional_0_For_10_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
  }
...
function OnboardingComponent_Conditional_0_For_10_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
  }
...
function OnboardingComponent_Conditional_0_For_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(9, OnboardingComponent_Conditional_0_For_10_Conditional_9_Template, 2, 3)(10, OnboardingComponent_Conditional_0_For_10_Conditional_10_Template, 2, 3)(11, OnboardingComponent_Conditional_0_For_10_Conditional_11_Template, 2, 3);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function OnboardingComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "lg-flex-column", 4);
    \u0275\u0275repeaterCreate(9, OnboardingComponent_Conditional_0_For_10_Template, 12, 14, "div", 5, _forTrack03);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
var OnboardingComponent = class _OnboardingComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OnboardingComponent, selectors: [["lg-onboarding"]], decls: 1, vars: 1, consts: [[1, "onboarding"], ["size", "medium"], [3, "level"], [1, "no-margin"], [3, "size"], [1, "onboarding__step", 3, "onboarding__step--done", "onboarding__step--disabled"], [1, "onboarding__step"], [1, "onboarding__step-content"], [1, "onboarding__step-label"], [1, "onboarding__step-desc"], [3, "onClick", "disabled"]], template: function OnboardingComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-KJMSCYAF.js.map
