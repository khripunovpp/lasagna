...
// src/app/shared/view/ui/form/multiselect.component.ts
...
var MultiselectComponent = class _MultiselectComponent {
  ...
  resource = input("");
  appendTo = input("");
  bindValue = input("uuid");
  bindLabel = input("name");
  ...
  compareWith = (a, b) => {
    ...
    return valA?.[field] === valB || valA === valB || valA?.[field] === valB?.[field] || valA === valB?.[field];
  };
  writeValue(value) {
    this.change(value);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MultiselectComponent, selectors: [["lg-multiselect"]], viewQuery: function MultiselectComponent_Query(rf, ctx) {
  ...
  }, inputs: { placeholder: "placeholder", resource: [1, "resource"], appendTo: [1, "appendTo"], bindValue: [1, "bindValue"], bindLabel: [1, "bindLabel"], autoLoad: [1, "autoLoad"], clearable: [1, "clearable"], multi: [1, "multi"], staticItems: [1, "staticItems"] }, outputs: { onSelected: "onSelected" }, features: [\u0275\u0275ProvidersFeature([
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => _MultiselectComponent),
      multi: true
    }
  ])], decls: 4, vars: 10, consts: [[1, "multiselect"], [3, "change", "ngModelChange", "compareWith", "items", "clearable", "bindValue", "bindLabel", "appendTo", "multiple", "ngModel", "placeholder", "searchFn"], ["ng-label-tmp", ""], ["ng-option-tmp", ""]], template: function MultiselectComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275property("compareWith", ctx.compareWith)("items", ctx.loadedList())("clearable", ctx.clearable())("bindValue", ctx.bindValue())("bindLabel", ctx.bindLabel())("appendTo", ctx.appendTo())("multiple", ctx.multi())("ngModel", ctx.value)("placeholder", ctx.placeholder)("searchFn", ctx.searchFn);
    }
  }, dependencies: [
    NgSelectComponent,
    FormsModule,
...
(() => {
  ...
  `, imports: [
    ...
    ], encapsulation: ViewEncapsulation.None, styles: ["/* angular:styles/component:scss;2571290d8fe82599a2692b7f827bba3593d94c9c09e2a6cb5f6ae589769e9213;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/form/multiselect.component.ts */\nlg-multiselect {\n  display: flex;\n  flex: 1;\n  min-width: 150px;\n}\n.multiselect {\n  flex: 1;\n  width: 100%;\n}\n.multiselect .ng-select.ng-select-focused .ng-select-container {\n  outline: none;\n  box-shadow: var(--focus-shadow);\n  border-radius: 12px;\n}\n.multiselect .ng-select.ng-select-single .ng-select-container {\n  height: 51px;\n}\n.multiselect .ng-select .ng-select-container {\n  border: none;\n  border-radius: 12px;\n  background-color: var(--control-bg);\n}\n.multiselect .ng-select .ng-select-container .ng-input {\n  top: 16px !important;\n}\n.multiselect .ng-select .ng-select-container .ng-input > input {\n  color: var(--text);\n  font-family: inherit;\n  font-size: inherit;\n}\n.multiselect .ng-dropdown-panel {\n  border: none;\n  box-shadow: 0 4px 16px 0 rgba(0, 0, 0, 0.1);\n  border-radius: 12px;\n  overflow: hidden;\n}\n.multiselect .ng-dropdown-panel .ng-option {\n  padding: 16px;\n  border-radius: 12px;\n}\n/*# sourceMappingURL=multiselect.component.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MultiselectComponent, { className: "MultiselectComponent", filePath: "src/app/shared/view/ui/form/multiselect.component.ts", lineNumber: 122 });
})();
...
//# sourceMappingURL=chunk-VSBYMVNN.js.map
