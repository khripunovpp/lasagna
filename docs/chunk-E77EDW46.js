...
(() => {
  ...
  `, imports: [
    ...
    ], styles: ["/* angular:styles/component:scss;c7c86030010025d4ab3486346eafa393469f90b5481ba15b8579779ecc6e5ae7;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/features/controls/dropdown/dropdown.component.ts */\n:host {\n  display: block;\n  position: relative;\n  z-index: 2;\n}\n.lg-dropdown {\n  position: relative;\n  display: inline-block;\n}\n.lg-dropdown-content {\n  display: none;\n  position: absolute;\n  top: calc(100% + 8px);\n  background-color: #f9f9f9;\n  min-width: 160px;\n  box-shadow: 0px 8px 16px 0px rgba(0, 0, 0, 0.2);\n  z-index: 1;\n  border-radius: 16px;\n  padding: 16px;\n}\n.lg-dropdown-open .lg-dropdown-content {\n  display: block;\n}\n.lg-dropdown-item {\n  color: black;\n  padding: 12px 16px;\n  text-decoration: none;\n  display: block;\n}\n.lg-dropdown-item:hover {\n  background-color: #f1f1f1;\n}\n/*# sourceMappingURL=dropdown.component.css.map */\n"] }]
  }], () => [], { onClick: [{
    type: HostListener,
    args: ["click", ["$event"]]
  }] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DropdownComponent, { className: "DropdownComponent", filePath: "src/app/features/controls/dropdown/dropdown.component.ts", lineNumber: 63 });
})();

export {
  DropdownComponent
};
//# sourceMappingURL=chunk-E77EDW46.js.map
