...
function GroupingTilesComponent_For_2_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngTemplateOutlet", ctx_r2.groupingHeaderDirective.templateRef)("ngTemplateOutletContext", \u0275\u0275pureFunction3(2, _c2, group_r5 == null ? null : group_r5.field, items_r6, !ctx_r2.collapsedState()[\u0275$index_3_r2]));
  }
}
...
function GroupingTilesComponent_For_2_For_8_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("key", tile_r7.uuid);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngTemplateOutlet", ctx_r2.groupingTileDirective.templateRef)("ngTemplateOutletContext", \u0275\u0275pureFunction1(3, _c3, tile_r7));
  }
}
function GroupingTilesComponent_For_2_For_8_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngTemplateOutlet", ctx_r2.groupingTileDirective.templateRef)("ngTemplateOutletContext", \u0275\u0275pureFunction1(2, _c3, tile_r7));
  }
}
function GroupingTilesComponent_For_2_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7);
    \u0275\u0275conditionalCreate(1, GroupingTilesComponent_For_2_For_8_Conditional_1_Template, 3, 5, "lg-selectable-section", 10)(2, GroupingTilesComponent_For_2_For_8_Conditional_2_Template, 2, 4, "div", 11);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function GroupingTilesComponent_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(7, GroupingTilesComponent_For_2_For_8_Template, 3, 1, "div", 7, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("grouping-tiles__section--collapsed", !ctx_r2.collapsedState()[\u0275$index_3_r2]);
    \u0275\u0275advance();
    const items_r8 = \u0275\u0275storeLet(group_r5.items);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.groupingHeaderDirective ? 3 : 4);
    \u0275\u0275advance(2);
    \u0275\u0275property("fontIcon", ctx_r2.collapsedState()[\u0275$index_3_r2] ? "expand_more" : "chevron_right");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(items_r8);
  }
}
...
var GroupingTilesComponent = class _GroupingTilesComponent {
  ...
  }, inputs: { sortResult: [1, "sortResult"], selectable: [1, "selectable"] }, ngContentSelectors: _c1, decls: 4, vars: 1, consts: [[1, "grouping-tiles"], [1, "grouping-tiles__section", 3, "grouping-tiles__section--collapsed"], [1, "grouping-tiles__section"], [1, "grouping-tiles__header", 3, "click"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [3, "fontIcon"], [1, "grouping-tiles__content"], [1, "grouping-tiles__item"], [3, "level"], [1, "grouping-tiles__header-count", "text-muted"], [3, "key"], [1, "grouping-tiles__item-inner"]], template: function GroupingTilesComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef(_c02);
      \u0275\u0275elementStart(0, "section", 0);
      \u0275\u0275repeaterCreate(1, GroupingTilesComponent_For_2_Template, 9, 5, "section", 1, _forTrack0, false, GroupingTilesComponent_ForEmpty_3_Template, 1, 0);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_0_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GroupingTilesComponent, { className: "GroupingTilesComponent", filePath: "src/app/shared/view/ui/grouping-tiles/grouping-tiles.component.ts", lineNumber: 135 });
})();
...
//# sourceMappingURL=chunk-OGJA434G.js.map
