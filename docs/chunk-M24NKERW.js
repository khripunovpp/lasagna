...
(() => {
  ...
  }], () => [], { mobileMode: [{ type: Input, args: [{ isSignal: true, alias: "mobileMode", required: false }] }], equal: [{ type: Input, args: [{ isSignal: true, alias: "equal", required: false }] }] });
})();
(() => {
...
//# sourceMappingURL=chunk-M24NKERW.js.map
