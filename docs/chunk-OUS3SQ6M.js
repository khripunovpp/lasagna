...
var TextareaComponent = class _TextareaComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TextareaComponent, selectors: [["lg-textarea"]], viewQuery: function TextareaComponent_Query(rf, ctx) {
  ...
  ])], decls: 2, vars: 5, consts: [["input", ""], [1, "textarea", 3, "input", "maxLength", "placeholder", "readonly", "value"]], template: function TextareaComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      \u0275\u0275property("maxLength", ctx.maxlength())("placeholder", ctx.placeholder())("readonly", ctx.readOnly())("value", ctx.value);
...
(() => {
  ...
  `, imports: [
    ...
    ], styles: ['/* angular:styles/component:scss;e4b9bc583e6b5e04e295ad877631fd8ba721364e90956f22f3e7e04d1e6f4738;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/form/textarea.component.ts */\n:host {\n  display: flex;\n  flex: 1;\n  position: relative;\n  opacity: 0.99;\n}\n.textarea {\n  flex: 1;\n  border: none;\n  border-radius: 12px;\n  padding: 16px;\n  background-color: var(--control-bg);\n  font-family: inherit;\n  font-size: inherit;\n}\n.textarea::placeholder {\n  color: var(--placeholder);\n}\n.textarea:focus {\n  outline: none;\n  box-shadow: var(--focus-shadow);\n}\n.textarea[readonly] {\n  background-color: transparent;\n  border: 1px solid var(--control-bg);\n}\n:host.readonly::after {\n  content: "";\n  position: absolute;\n  z-index: -1;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: var(--control-bg);\n  border-radius: 12px;\n  opacity: 0.4;\n}\n/*# sourceMappingURL=textarea.component.css.map */\n'] }]
  }], () => [], { input: [{
    type: ViewChild,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TextareaComponent, { className: "TextareaComponent", filePath: "src/app/shared/view/ui/form/textarea.component.ts", lineNumber: 80 });
})();

export {
  TextareaComponent
};
//# sourceMappingURL=chunk-OUS3SQ6M.js.map
