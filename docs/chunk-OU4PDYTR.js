...
var HtmlEditorComponent = class _HtmlEditorComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HtmlEditorComponent, selectors: [["lg-html-editor"]], inputs: { placeholder: [1, "placeholder"] }, features: [\u0275\u0275ProvidersFeature([
  ...
  ])], decls: 2, vars: 6, consts: [[3, "editor", "toolbar"], [3, "disabled", "editor", "formControl", "placeholder"]], template: function HtmlEditorComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("disabled", false)("editor", ctx.editor)("formControl", ctx.htmlString)("placeholder", ctx.placeholder());
    }
  }, dependencies: [
    NgxEditorMenuComponent,
    NgxEditorComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HtmlEditorComponent, { className: "HtmlEditorComponent", filePath: "src/app/shared/view/ui/html-editor/html-editor.component.ts", lineNumber: 57 });
})();
...
//# sourceMappingURL=chunk-OU4PDYTR.js.map
