...
import {
  RecipeScheme
} from "./chunk-6QJRVB2P.js";
import "./chunk-KQA7PU67.js";
import {
  ControlsBarComponent
} from "./chunk-JUM6LPIW.js";
import {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddRecipeFormComponent, { className: "AddRecipeFormComponent", filePath: "src/app/features/recipes/view/add-recipe/add-recipe-form.component.ts", lineNumber: 93 });
})();
...
var AddRecipeComponent = class _AddRecipeComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddRecipeComponent, selectors: [["lg-add-recipe"]], viewQuery: function AddRecipeComponent_Query(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(((tmp_6_0 = ctx.recipe()) == null ? null : tmp_6_0.uuid) && !ctx.draftRef() || ctx.draftRef() && ctx.draftByExistingRecipe() ? 9 : 10);
    }
  }, dependencies: [
    ContainerComponent,
    TitleComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AddRecipeComponent, [{
    type: Component,
    args: [{ selector: "lg-add-recipe", standalone: true, imports: [
      ContainerComponent,
      TitleComponent,
      AddRecipeFormComponent,
      ButtonComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddRecipeComponent, { className: "AddRecipeComponent", filePath: "src/app/features/recipes/view/add-recipe/add-recipe.component.ts", lineNumber: 179 });
})();
export {
  AddRecipeComponent
};
//# sourceMappingURL=chunk-ZUYXDYCI.js.map
