...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TagsControlComponent, { className: "TagsControlComponent", filePath: "src/app/features/controls/form/tags-control.component.ts", lineNumber: 128 });
})();
...
function AddRecipeFormComponent_For_23_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind2(15, 22, "recipe.form.ingredients.amount.placeholder", \u0275\u0275pureFunction1(25, _c4, (ctx_r3.form.value.ingredients == null ? null : ctx_r3.form.value.ingredients[\u0275$index_39_r3] == null ? null : ctx_r3.form.value.ingredients[\u0275$index_39_r3].unit) || ctx_r3.UnitValue.GRAM)));
    \u0275\u0275advance(5);
    \u0275\u0275styleMap("danger");
                ...
                <ng-container [formGroupName]="i">
                  <lg-controls-row [mobileMode]="true">
                    ...
                    <lg-number-input #amount
                                     lgParseMath
                                     (onKeydown)="addLast()"
                                     [placeholder]="'recipe.form.ingredients.amount.placeholder'|translate:{unit:(form.value.ingredients?.[i]?.unit || UnitValue.GRAM)}"
...
//# sourceMappingURL=chunk-TAB6TAKN.js.map
