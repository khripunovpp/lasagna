...
function ExpanderComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ExpanderComponent_Conditional_1_Conditional_0_Template, 4, 3, "div", 1);
...
(() => {
  ...
  `, imports: [
      FlexColumnComponent,
      TranslatePipe
    ], styles: ["/* angular:styles/component:scss;5f2a0543c39ae4aaa93ade84d960e64f700b190477158eb81b25032cde54050b;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/expander.component.ts */\n.expander {\n  display: flex;\n  flex-direction: column;\n  border-radius: 32px;\n  background-color: #fff;\n  overflow: hidden;\n}\n.expander__trigger,\n.expander__close {\n  cursor: pointer;\n}\n.expander__close {\n  text-align: right;\n}\n.expander__header {\n  padding: 24px;\n}\n.expander__content {\n  padding: 24px;\n}\n.expander.opened .expander__header {\n  background-color: var(--control-bg);\n}\n.expander.flat {\n  background-color: transparent;\n  border-radius: 0;\n}\n.expander.flat .expander__content {\n  padding: 0;\n}\n.expander.flat .expander__header {\n  padding: 0;\n}\n/*# sourceMappingURL=expander.component.css.map */\n"] }]
  }], () => [], { openLabel: [{
    type: Input
  }], closeLabel: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExpanderComponent, { className: "ExpanderComponent", filePath: "src/app/shared/view/ui/expander.component.ts", lineNumber: 87 });
})();

export {
  ExpanderComponent
};
//# sourceMappingURL=chunk-76XLOHPG.js.map
