...
var GroupingSortingComponent = class _GroupingSortingComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GroupingSortingComponent, selectors: [["lg-grouping-sorting"]], contentQueries: function GroupingSortingComponent_ContentQueries(rf, ctx, dirIndex) {
  ...
  }, outputs: { sortChange: "sortChange", groupChange: "groupChange" }, decls: 33, vars: 55, consts: [["size", "medium", 3, "mobileMode"], ["lgDropdownAnchor", "", 3, "size"], [3, "size"], [3, "click", "flat", "size"]], template: function GroupingSortingComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("size", "small");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 39, "grouping.title"));
      \u0275\u0275advance(2);
      \u0275\u0275styleMap("warning");
      \u0275\u0275property("flat", true)("size", "small");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 41, ctx.groupingToLabel["category"]), " ");
      \u0275\u0275advance(2);
      \u0275\u0275styleMap("warning");
      \u0275\u0275property("flat", true)("size", "small");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(13, 43, ctx.groupingToLabel["tag"]), " ");
      \u0275\u0275advance(2);
      \u0275\u0275styleMap("warning");
      \u0275\u0275property("flat", true)("size", "small");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(16, 45, ctx.groupingToLabel["createdAt"]), " ");
      \u0275\u0275advance(2);
      \u0275\u0275styleMap("warning");
      \u0275\u0275property("flat", true)("size", "small");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(19, 47, ctx.groupingToLabel["alphabetical"]), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("size", "small");
      \u0275\u0275advance();
      ...
      \u0275\u0275property("size", "small");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(26, 49, "grouping.direction.title"));
      \u0275\u0275advance(2);
      \u0275\u0275styleMap("warning");
      \u0275\u0275property("flat", true)("size", "small");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(29, 51, ctx.groupingDirectionToLabel["asc"]), " ");
      \u0275\u0275advance(2);
      \u0275\u0275styleMap("warning");
      \u0275\u0275property("flat", true)("size", "small");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(32, 53, ctx.groupingDirectionToLabel["desc"]), " ");
    }
  }, dependencies: [
    FlexRowComponent,
    ButtonComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GroupingSortingComponent, { className: "GroupingSortingComponent", filePath: "src/app/shared/view/ui/grouping-sorting/grouping-sorting.component.ts", lineNumber: 110 });
})();
...
function RecipesListComponent_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-card")(1, "lg-flex-column", 14)(2, "a", 15);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "lg-flex-row")(5, "lg-button", 16);
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "small", 17);
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275pipe(11, "timeAgo");
    \u0275\u0275elementEnd()()()();
...
//# sourceMappingURL=chunk-7FZ46NLQ.js.map
