...
import "./chunk-LWSH7HL2.js";
import "./chunk-CU6H67XS.js";
import {
  PullDirective
...
function ProductListComponent_ng_template_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", product_r5.name, " ", product_r5.source ? "- " + product_r5.source : "", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(7, 9, product_r5.pricePerUnit, "1.0-5"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("translateParams", \u0275\u0275pureFunction1(20, _c2, \u0275\u0275pipeBind1(10, 14, \u0275\u0275pipeBind1(9, 12, product_r5 == null ? null : product_r5.unit))))("translate", "per-unit.label");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind1(13, 16, "edited-at-label"), " ", \u0275\u0275pipeBind1(14, 18, (product_r5 == null ? null : product_r5.updatedAt) || (product_r5 == null ? null : product_r5.createdAt)), " ");
  }
}
var ProductListComponent = class _ProductListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductListComponent, selectors: [["lg-product-list"]], features: [\u0275\u0275ProvidersFeature([
    ...
    if (rf & 1) {
      ...
      \u0275\u0275template(11, ProductListComponent_ng_template_11_Template, 15, 22, "ng-template", 4);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 13, "products.list-title"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("translateParams", \u0275\u0275pureFunction1(19, _c02, (tmp_3_0 = ctx.productsTiles()) == null ? null : tmp_3_0.length))("translate", "filters.results.length");
      \u0275\u0275advance(2);
      \u0275\u0275conditional(!groupingTiles_r6.empty() ? 8 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("selectable", true)("sortResult", ctx.productsTiles());
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(14, 15, "products.empty-state.text"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275styleMap("primary");
      \u0275\u0275property("link", "/products/add")("size", "medium");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(17, 17, "products.empty-state.btn"), " ");
    }
  }, dependencies: [
    FlexRowComponent,
    ButtonComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductListComponent, { className: "ProductListComponent", filePath: "src/app/features/products/view/list/product-list.component.ts", lineNumber: 171 });
})();
export {
  ProductListComponent
};
//# sourceMappingURL=chunk-65AVVSX4.js.map
