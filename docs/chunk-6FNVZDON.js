...
} from "./chunk-42KC5R7A.js";
import {
  matchMediaSignal,
  mobileBreakpoint
} from "./chunk-YIUZO3M7.js";
import "./chunk-EYLICJXQ.js";
...
var CurrencySelectComponent = class _CurrencySelectComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CurrencySelectComponent, selectors: [["lg-currency-select"]], inputs: { lang: [1, "lang"], selectedCurrency: [1, "selectedCurrency"] }, outputs: { selectedCurrency: "selectedCurrencyChange" }, features: [\u0275\u0275ProvidersFeature([
  ...
  ])], decls: 5, vars: 11, consts: [[3, "size"], [3, "label"], ["bindLabel", "label", "bindValue", "code", 3, "onSelected", "clearable", "multi", "ngModel", "placeholder", "staticItems"]], template: function CurrencySelectComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("clearable", false)("multi", false)("ngModel", ctx.selectedCurrency())("placeholder", \u0275\u0275pipeBind1(4, 9, "currency.select-placeholder"))("staticItems", ctx.currencyList);
    }
  }, dependencies: [
    CommonModule,
    ReactiveFormsModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CurrencySelectComponent, { className: "CurrencySelectComponent", filePath: "src/app/shared/view/ui/form/currency-select.component.ts", lineNumber: 58 });
})();
...
//# sourceMappingURL=chunk-6FNVZDON.js.map
