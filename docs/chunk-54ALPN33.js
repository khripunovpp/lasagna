...
// src/app/shared/view/ui/layout/flex-column.component.ts
var _c0 = ["*"];
...
(() => {
  ...
  `, imports: [
      NgClass
    ], changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;624c658dacbe3d3722e43fda799c237075128a304b52c375b77c25ef186a9ffa;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/layout/flex-column.component.ts */\n:host {\n  flex: 1;\n}\n@media (max-width: 768px) {\n  :host {\n    width: 100%;\n  }\n}\n.gap-column {\n  display: flex;\n  flex-direction: column;\n  gap: 32px;\n}\n.gap-column.small {\n  gap: 8px;\n}\n.gap-column.medium {\n  gap: 16px;\n}\n.gap-column.tiny {\n  gap: 4px;\n}\n.gap-column.fill {\n  justify-content: space-between;\n  height: 100%;\n}\n@media (max-width: 768px) {\n  .gap-column {\n    display: flex;\n    flex-direction: column;\n    gap: 16px;\n  }\n  .gap-column.small {\n    gap: 4px;\n  }\n  .gap-column.medium {\n    gap: 8px;\n  }\n  .gap-column.tiny {\n    gap: 2px;\n  }\n}\n/*# sourceMappingURL=flex-column.component.css.map */\n"] }]
  }], () => [], { fill: [{
    type: Input
  }], expandMobile: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FlexColumnComponent, { className: "FlexColumnComponent", filePath: "src/app/shared/view/ui/layout/flex-column.component.ts", lineNumber: 74 });
})();

export {
  FlexColumnComponent
};
//# sourceMappingURL=chunk-54ALPN33.js.map
