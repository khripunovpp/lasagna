...
function CalculateRecipeComponent_Conditional_10_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, CalculateRecipeComponent_Conditional_10_Conditional_19_ng_container_0_Template, 1, 0, "ng-container", 18);
  }
  if (rf & 2) {
    \u0275\u0275nextContext(2);
...
function CalculateRecipeComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "lg-flex-column", 10)(11, "lg-card", 8)(12, "lg-flex-row", 9)(13, "div");
    \u0275\u0275text(14);
    \u0275\u0275pipe(15, "translate");
    \u0275\u0275elementStart(16, "b");
    \u0275\u0275text(17);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275element(21, "lg-flex-row", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "lg-flex-column", 10)(23, "lg-card", 8)(24, "lg-flex-row", 9)(25, "div");
    \u0275\u0275text(26);
    \u0275\u0275pipe(27, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "b");
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "lg-flex-column", 12)(33, "div");
    \u0275\u0275text(34);
    \u0275\u0275pipe(35, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(36, "lg-calculation-price-modifiers", 13);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(37, "lg-card", 14)(38, "lg-flex-column", 15)(39, "lg-title", 16)(40, "div");
    \u0275\u0275text(41);
    \u0275\u0275pipe(42, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(43, "canvas", 17, 1);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(45, "lg-card", 14)(46, "lg-flex-column", 15)(47, "lg-title", 16)(48, "div");
    \u0275\u0275text(49);
    \u0275\u0275pipe(50, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "canvas", 17, 2);
...
function CalculateRecipeComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(29, CalculateRecipeComponent_Conditional_13_For_30_Template, 18, 17, "tr", 20, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    let tmp_7_0;
