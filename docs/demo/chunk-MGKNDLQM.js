...
// src/app/shared/view/ui/form/control-extra-template.directive.ts
...
// src/app/shared/view/ui/form/input.component.ts
var _c0 = ["input"];
...
(() => {
  ...
  `, imports: [
    ...
    ], styles: ["/* angular:styles/component:scss;4b961b3a35db017c9965fb09656c2e44fc4b38273166670ddd9aba46569f9a0b;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/form/input.component.ts */\n:host {\n  display: flex;\n  flex: 1;\n}\n:host.focused {\n  box-shadow: var(--focus-shadow);\n  border-radius: 12px;\n}\n.lg-input {\n  display: flex;\n  flex: 1;\n  background-color: var(--control-bg);\n  border-radius: 12px;\n  gap: 16px;\n}\n.lg-input__after {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  padding: 0 16px;\n  white-space: nowrap;\n  flex: 0 0 auto;\n}\n.lg-input__before {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  padding: 0 16px;\n  white-space: nowrap;\n  flex: 0 0 auto;\n}\n.input {\n  flex: 1;\n  border: none;\n  padding: 16px;\n  border-radius: 12px;\n  font-family: inherit;\n  font-size: inherit;\n  background-color: transparent;\n  width: 100%;\n}\n.input::placeholder {\n  color: var(--placeholder);\n}\n.input:focus {\n  outline: none;\n}\n/*# sourceMappingURL=input.component.css.map */\n"] }]
  }], () => [], { input: [{
    type: ViewChild,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InputComponent, { className: "InputComponent", filePath: "src/app/shared/view/ui/form/input.component.ts", lineNumber: 119 });
})();
...
//# sourceMappingURL=chunk-MGKNDLQM.js.map
