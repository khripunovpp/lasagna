...
// src/app/shared/view/widgets/barcode-seeker/barcode-seeker.component.ts
function BarcodeSeekerWidgetComponent_Conditional_4_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-gap-column", 0)(1, "lg-control", 6)(2, "lg-input", 4);
    \u0275\u0275twoWayListener("ngModelChange", function BarcodeSeekerWidgetComponent_Conditional_4_Conditional_8_Template_lg_input_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r3);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "lg-control", 6)(4, "lg-number-input", 4);
    \u0275\u0275twoWayListener("ngModelChange", function BarcodeSeekerWidgetComponent_Conditional_4_Conditional_8_Template_lg_number_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.product.amount, $event) || (ctx_r1.product.amount = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "lg-control", 6)(6, "lg-number-input", 4);
    \u0275\u0275twoWayListener("ngModelChange", function BarcodeSeekerWidgetComponent_Conditional_4_Conditional_8_Template_lg_number_input_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.product.price, $event) || (ctx_r1.product.price = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "lg-button", 7);
    \u0275\u0275listener("click", function BarcodeSeekerWidgetComponent_Conditional_4_Conditional_8_Template_lg_button_click_9_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.addProduct());
    });
    \u0275\u0275text(10, "Add product");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("label", "Name");
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.product.name);
    \u0275\u0275property("placeholder", "Name");
    \u0275\u0275advance();
    \u0275\u0275property("label", "Amount");
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.product.amount);
    \u0275\u0275property("placeholder", "Amount");
    \u0275\u0275advance();
    \u0275\u0275property("label", "Price");
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.product.price);
    \u0275\u0275property("placeholder", "Price");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.product.unit);
  }
}
function BarcodeSeekerWidgetComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275element(0, "video", 2);
    \u0275\u0275elementStart(1, "lg-gap-column")(2, "lg-gap-row", 3)(3, "lg-input", 4);
    \u0275\u0275twoWayListener("ngModelChange", function BarcodeSeekerWidgetComponent_Conditional_4_Template_lg_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.barcode, $event) || (ctx_r1.barcode = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "lg-button", 5);
    \u0275\u0275listener("click", function BarcodeSeekerWidgetComponent_Conditional_4_Template_lg_button_click_4_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onBarcodeManualInput());
    });
    \u0275\u0275text(5, "Search");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "lg-button", 5);
    \u0275\u0275listener("click", function BarcodeSeekerWidgetComponent_Conditional_4_Template_lg_button_click_6_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(7, "Clear");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(8, BarcodeSeekerWidgetComponent_Conditional_4_Conditional_8_Template, 11, 11, "lg-gap-column", 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.barcode);
    \u0275\u0275property("placeholder", "Barcode");
    \u0275\u0275advance(5);
    \u0275\u0275conditional(ctx_r1.showProductForm() && ctx_r1.productResult() ? 8 : -1);
  }
}
function BarcodeSeekerWidgetComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-button", 5);
    \u0275\u0275listener("click", function BarcodeSeekerWidgetComponent_Conditional_5_Template_lg_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.openScanner());
    });
    \u0275\u0275text(1, "Scan");
    \u0275\u0275elementEnd();
  }
}
var BarcodeSeekerWidgetComponent = class _BarcodeSeekerWidgetComponent {
  _openFoodFactsService;
  _arcodeReaderService;
  _productRepository;
  _notificationService;
  constructor(_openFoodFactsService, _arcodeReaderService, _productRepository, _notificationService) {
    this._openFoodFactsService = _openFoodFactsService;
    this._arcodeReaderService = _arcodeReaderService;
  ...
  productResult = computed(() => {
    ...
    if (resp?.status === 1) {
      ...
      return __spreadValues({}, this.product);
    }
    return null;
  });
  ...
  detectUnit(product) {
    ...
    if (qty.includes("g") || qty.includes("ml"))
      return "gram";
    if (qty.includes("pc") || qty.includes("\u0448\u0442"))
      return "piece";
    return "gram";
  }
  addProduct() {
  ...
  startCamera() {
    return this._arcodeReaderService.startCamera("video", (result) => {
      if (result) {
  ...
  static \u0275fac = function BarcodeSeekerWidgetComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BarcodeSeekerWidgetComponent)(\u0275\u0275directiveInject(OpenFoodFactsService), \u0275\u0275directiveInject(BarcodeReaderService), \u0275\u0275directiveInject(ProductsRepository), \u0275\u0275directiveInject(NotificationsService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BarcodeSeekerWidgetComponent, selectors: [["lg-barcode-add-product-widget"]], inputs: { showFormInitially: [1, "showFormInitially"], showScanerInitially: [1, "showScanerInitially"] }, outputs: { productAdded: "productAdded" }, features: [\u0275\u0275ProvidersFeature([])], decls: 6, vars: 4, consts: [[3, "size"], [3, "top", "mobileMode"], ["id", "video"], ["lgExpand", ""], ["lgExpand", "", "lgParseMath", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "click"], [3, "label"], ["lgShrink", "", 3, "click"]], template: function BarcodeSeekerWidgetComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-gap-column", 0)(1, "lg-title");
      \u0275\u0275text(2, " \u{1F4F7} Scan barcode or enter manually ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "lg-gap-row", 1);
      \u0275\u0275conditionalCreate(4, BarcodeSeekerWidgetComponent_Conditional_4_Template, 9, 3)(5, BarcodeSeekerWidgetComponent_Conditional_5_Template, 2, 0, "lg-button");
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275property("size", "medium");
      \u0275\u0275advance(3);
      \u0275\u0275property("top", true)("mobileMode", true);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.showScanner() ? 4 : 5);
    }
  }, dependencies: [
    FormsModule,
    NgControlStatus,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BarcodeSeekerWidgetComponent, [{
    type: Component,
    args: [{ selector: "lg-barcode-add-product-widget", standalone: true, imports: [
      FormsModule,
      GapColumnComponent,
      InputComponent,
      TitleComponent,
      ...
      ControlComponent,
      ShrinkDirective
    ], providers: [], template: `<lg-gap-column [size]="'medium'">
  <lg-title>
    \u{1F4F7} Scan barcode or enter manually
  </lg-title>

  <lg-gap-row [top]="true" [mobileMode]="true">
    @if (showScanner()) {
...
` }]
  }], () => [{ type: OpenFoodFactsService }, { type: BarcodeReaderService }, { type: ProductsRepository }, { type: NotificationsService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BarcodeSeekerWidgetComponent, { className: "BarcodeSeekerWidgetComponent", filePath: "src/app/shared/view/widgets/barcode-seeker/barcode-seeker.component.ts", lineNumber: 45 });
})();

// src/app/shared/view/ui/form/buttons-group.component.ts
...
function ButtonsGroupComponent_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("active", ctx_r4.activeIndex() == \u0275$index_3_r4)("flat", ctx_r4.flat)("noScale", true)("size", item_r3.size || "default")("noLeftRadius", \u0275$index_3_r4 === \u0275$count_3_r6 - 1)("noRightRadius", \u0275$index_3_r4 === 0)("noRadius", !(\u0275$index_3_r4 === 0) && !(\u0275$index_3_r4 === \u0275$count_3_r6 - 1));
    \u0275\u0275advance();
...
var ButtonsGroupComponent = class _ButtonsGroupComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ButtonsGroupComponent, selectors: [["lg-buttons-group"]], inputs: { flat: "flat", items: [1, "items"] }, features: [\u0275\u0275ProvidersFeature([
    ...
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(1, ButtonsGroupComponent_For_2_Template, 2, 12, "lg-button", 1, _forTrack0);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
  ...
  }, dependencies: [ButtonComponent], styles: ["/* angular:styles/component:scss;63d697a2fbda6e5b7bb22c3d1c660a21b49f172829c70d6948f749d6e521994e;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/form/buttons-group.component.ts */\n.buttons-group {\n  display: flex;\n}\n.buttons-group lg-button {\n  flex: 1;\n}\n.buttons-group lg-button button {\n  width: 100%;\n}\n.buttons-group--flat {\n  gap: 16px;\n  width: 100%;\n}\n/*# sourceMappingURL=buttons-group.component.css.map */\n"], encapsulation: 2 });
};
(() => {
  ...
  `, imports: [
    ...
    ], styles: ["/* angular:styles/component:scss;63d697a2fbda6e5b7bb22c3d1c660a21b49f172829c70d6948f749d6e521994e;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/form/buttons-group.component.ts */\n.buttons-group {\n  display: flex;\n}\n.buttons-group lg-button {\n  flex: 1;\n}\n.buttons-group lg-button button {\n  width: 100%;\n}\n.buttons-group--flat {\n  gap: 16px;\n  width: 100%;\n}\n/*# sourceMappingURL=buttons-group.component.css.map */\n"] }]
  }], null, { flat: [{
    type: Input
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ButtonsGroupComponent, { className: "ButtonsGroupComponent", filePath: "src/app/shared/view/ui/form/buttons-group.component.ts", lineNumber: 68 });
})();

// src/app/shared/view/widgets/jelly-widget/jelly-calculation.model.ts
var convertPairs = {
  powder: {
    mass: (amount) => {
...
// src/app/shared/view/ui/form/range.component.ts
...
(() => {
  ...
  `, imports: [
    ...
    ], styles: ["/* angular:styles/component:scss;348bee4c7247d4581eab701a06390868508a42c5ac0805764907ddc7c01d5efd;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/form/range.component.ts */\n.range-wrapper {\n  position: relative;\n  width: 100%;\n  padding-bottom: 30px;\n}\n.custom-range {\n  width: 100%;\n  -webkit-appearance: none;\n  background: transparent;\n  position: relative;\n  z-index: 2;\n  margin: 0;\n}\n.custom-range::-webkit-slider-runnable-track {\n  height: 6px;\n  background: #ddd;\n  border-radius: 3px;\n}\n.custom-range::-moz-range-track {\n  height: 6px;\n  background: #ddd;\n  border-radius: 3px;\n}\n.custom-range::-webkit-slider-thumb {\n  -webkit-appearance: none;\n  height: 20px;\n  width: 20px;\n  background: var(--accent-color);\n  border-radius: 50%;\n  margin-top: -7px;\n  cursor: pointer;\n}\n.custom-range::-moz-range-thumb {\n  height: 20px;\n  width: 20px;\n  background: var(--accent-color);\n  border-radius: 50%;\n  cursor: pointer;\n}\n.ticks {\n  position: absolute;\n  top: 28px;\n  left: 2.4%;\n  right: 2.4%;\n  height: 30px;\n  pointer-events: none;\n}\n.tick {\n  position: absolute;\n  text-align: center;\n  transform: translateX(-50%);\n}\n.tick-line {\n  width: 1px;\n  height: 10px;\n  background-color: #666;\n  margin: 0 auto;\n}\n.label {\n  font-size: 10px;\n  color: #666;\n  margin-top: 2px;\n  display: block;\n}\n/*# sourceMappingURL=range.component.css.map */\n"] }]
  }], () => [], { min: [{
    type: Input
  }], max: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RangeComponent, { className: "RangeComponent", filePath: "src/app/shared/view/ui/form/range.component.ts", lineNumber: 121 });
})();

// src/app/shared/view/widgets/jelly-widget/jelly-widget.component.ts
function JellyWidgetComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " grams of ");
  }
}
function JellyWidgetComponent_Case_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " \u{1F35A} ");
  }
}
function JellyWidgetComponent_Case_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " \u{1F343} ");
  }
}
...
function JellyWidgetComponent_Conditional_24_Case_2_Template(rf, ctx) {
  if (rf & 1) {
...
function JellyWidgetComponent_Conditional_24_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275text(1, " And ");
    \u0275\u0275elementEnd();
...
function JellyWidgetComponent_Conditional_24_Case_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275text(1, " And ");
    \u0275\u0275elementEnd();
...
function JellyWidgetComponent_Conditional_24_Case_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "br");
    \u0275\u0275text(1, "included ");
  }
}
function JellyWidgetComponent_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-gap-column", 9)(1, "div");
    \u0275\u0275conditionalCreate(2, JellyWidgetComponent_Conditional_24_Case_2_Template, 2, 0, "div");
    \u0275\u0275conditionalCreate(3, JellyWidgetComponent_Conditional_24_Case_3_Template, 2, 0, "div")(4, JellyWidgetComponent_Conditional_24_Case_4_Template, 2, 0, "div");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "lg-gap-row", 10)(6, "div");
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275text(9, " \u{1F4A7} ");
    ...
    \u0275\u0275text(11, " ml of water ");
    \u0275\u0275conditionalCreate(12, JellyWidgetComponent_Conditional_24_Case_12_Template, 2, 0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_5_0;
    ...
    const toType_r2 = \u0275\u0275readContextLet(10);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(8, 7, ctx_r0.waterNeeded(), "1.0-2"));
    \u0275\u0275advance(5);
    \u0275\u0275conditional((tmp_9_0 = toType_r2) === "mass" ? 12 : -1);
  }
}
var JellyWidgetComponent = class _JellyWidgetComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _JellyWidgetComponent, selectors: [["lg-jelly-widget"]], decls: 27, vars: 25, consts: [[3, "formGroup"], [3, "bottom", "mobileMode"], ["formGroupName", "from"], ["formControlName", "amount", "lgParseMath", "", 3, "placeholder"], ["lgExtraTpl", "", "place", "after"], ["formControlName", "bloom", 3, "min", "max", "step", "tickInterval"], ["formControlName", "type", 3, "items"], ["formGroupName", "to"], [1, "text-center", 3, "strictCenter"], ["lgShrink", "", 3, "size", "position"], [2, "font-size", "2rem", 3, "size"]], template: function JellyWidgetComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-gap-column")(1, "form", 0)(2, "lg-gap-row", 1)(3, "lg-gap-column", 2);
      \u0275\u0275text(4, " In recipe you have ");
      \u0275\u0275elementStart(5, "lg-number-input", 3);
      \u0275\u0275template(6, JellyWidgetComponent_ng_template_6_Template, 1, 0, "ng-template", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275element(7, "lg-range", 5)(8, "lg-buttons-group", 6);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "lg-gap-column", 7);
      \u0275\u0275declareLet(10);
      \u0275\u0275elementStart(11, "lg-gap-row", 8)(12, "lg-gap-column", 9)(13, "div");
      \u0275\u0275text(14, " You need ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "lg-gap-row", 10)(16, "div");
      \u0275\u0275text(17);
      \u0275\u0275pipe(18, "number");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(19, JellyWidgetComponent_Case_19_Template, 1, 0)(20, JellyWidgetComponent_Case_20_Template, 1, 0)(21, JellyWidgetComponent_Case_21_Template, 1, 0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "div");
      \u0275\u0275text(23, " grams of ");
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(24, JellyWidgetComponent_Conditional_24_Template, 13, 10, "lg-gap-column", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275element(25, "lg-range", 5)(26, "lg-buttons-group", 6);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      let tmp_16_0;
      ...
      \u0275\u0275property("placeholder", "Amount");
      \u0275\u0275advance(2);
      \u0275\u0275property("min", 120)("max", 220)("step", 10)("tickInterval", 20);
      \u0275\u0275advance();
      ...
      \u0275\u0275property("size", "small");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(18, 22, ctx.result(), "1.0-2"));
      \u0275\u0275advance(2);
      \u0275\u0275conditional((tmp_16_0 = toType_r3) === "powder" ? 19 : tmp_16_0 === "leaf" ? 20 : tmp_16_0 === "mass" ? 21 : -1);
      \u0275\u0275advance(5);
      \u0275\u0275conditional(ctx.waterNeeded() ? 24 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("min", 120)("max", 220)("step", 10)("tickInterval", 20);
      \u0275\u0275advance();
      \u0275\u0275property("items", ctx.typeButtons);
...
(() => {
  ...
  `, imports: [
      ...
      ParseMathDirective,
      ControlExtraTemplateDirective
    ], encapsulation: ViewEncapsulation.None, styles: ["/* angular:styles/component:scss;5a39d192d96ec09463df6f20ba4b5531f431e94c284e4b4879a1ba546f1b7597;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/widgets/jelly-widget/jelly-widget.component.ts */\n:host {\n  --control-bg: #fcfcfc;\n}\nlg-eggs-widget {\n  display: flex;\n}\n.eggs-widget {\n  display: flex;\n  flex-direction: column;\n}\n.eggs-widget__eggs {\n  display: flex;\n  align-items: flex-end;\n  gap: 8px;\n}\n.eggs-widget__eggs img {\n  width: 40px;\n}\n.eggs-widget__egg {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex: 1;\n  flex-direction: column;\n  white-space: nowrap;\n  gap: 8px;\n  background-color: var(--control-bg);\n  border-radius: 24px;\n  padding: 16px;\n}\n.eggs-widget__egg:first-child img {\n  transform: scale(0.8);\n}\n.eggs-widget__egg:last-child img {\n  transform: scale(1.2);\n}\n.eggs-widget__egg.selected {\n  background-color: #61b789;\n}\n.eggs-widget__egg.selected:first-child {\n  background-color: #b4b8f8;\n}\n.eggs-widget__egg.selected:last-child {\n  background-color: #ff8080;\n}\n/*# sourceMappingURL=jelly-widget.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(JellyWidgetComponent, { className: "JellyWidgetComponent", filePath: "src/app/shared/view/widgets/jelly-widget/jelly-widget.component.ts", lineNumber: 204 });
})();

// src/app/shared/view/widgets/widgets-page/widgets-page.component.ts
function WidgetsPageComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
...
function WidgetsPageComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "lg-barcode-add-product-widget");
  }
}
var WidgetsPageComponent = class _WidgetsPageComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WidgetsPageComponent, selectors: [["lg-widgets-page"]], decls: 9, vars: 1, consts: [[3, "center"], ["label", "Jelly calculator", "alias", "jelly-calculator", "lgTab", ""], ["label", "Eggs calculator", "alias", "eggs-calculator", "lgTab", ""], ["label", "Barcode Seeker", "alias", "barcode-seeker", "lgTab", ""]], template: function WidgetsPageComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-fade-in")(1, "lg-container")(2, "lg-gap-row", 0)(3, "lg-title");
      \u0275\u0275text(4, " Widgets ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(5, "lg-tabs");
      \u0275\u0275template(6, WidgetsPageComponent_ng_template_6_Template, 1, 0, "ng-template", 1)(7, WidgetsPageComponent_ng_template_7_Template, 1, 0, "ng-template", 2)(8, WidgetsPageComponent_ng_template_8_Template, 1, 0, "ng-template", 3);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WidgetsPageComponent, { className: "WidgetsPageComponent", filePath: "src/app/shared/view/widgets/widgets-page/widgets-page.component.ts", lineNumber: 58 });
})();
export {
  WidgetsPageComponent
};
//# sourceMappingURL=chunk-AY3NS3UB.js.map
