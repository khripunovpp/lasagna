...
function AddCategoryFormComponent_Conditional_5_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Save category ");
  }
}
function AddCategoryFormComponent_Conditional_5_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " No changes ");
  }
}
function AddCategoryFormComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-button", 6);
    \u0275\u0275listener("click", function AddCategoryFormComponent_Conditional_5_Template_lg_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.editCategory());
    });
    \u0275\u0275conditionalCreate(1, AddCategoryFormComponent_Conditional_5_Conditional_1_Template, 1, 0)(2, AddCategoryFormComponent_Conditional_5_Conditional_2_Template, 1, 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function AddCategoryFormComponent_Conditional_6_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Add category ");
  }
}
function AddCategoryFormComponent_Conditional_6_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Enter a name ");
  }
}
function AddCategoryFormComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-button", 6);
    \u0275\u0275listener("click", function AddCategoryFormComponent_Conditional_6_Template_lg_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.addCategory());
    });
    \u0275\u0275conditionalCreate(1, AddCategoryFormComponent_Conditional_6_Conditional_1_Template, 1, 0)(2, AddCategoryFormComponent_Conditional_6_Conditional_2_Template, 1, 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var AddCategoryFormComponent = class _AddCategoryFormComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddCategoryFormComponent, selectors: [["lg-add-category-form"]], inputs: { uuid: [1, "uuid"] }, decls: 7, vars: 5, consts: [[3, "formGroup"], [3, "bottom", "mobileMode"], ["label", "Name", "lgExpand", ""], ["formControlName", "name", 3, "onEnter", "placeholder"], ["lgNoWrap", ""], [3, "disabled"], [3, "click", "disabled"]], template: function AddCategoryFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "form", 0)(1, "lg-gap-row", 1)(2, "lg-control", 2)(3, "lg-input", 3);
      \u0275\u0275listener("onEnter", function AddCategoryFormComponent_Template_lg_input_onEnter_3_listener() {
        return ctx.onEnter();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(4, "div", 4);
      \u0275\u0275conditionalCreate(5, AddCategoryFormComponent_Conditional_5_Template, 3, 2, "lg-button", 5)(6, AddCategoryFormComponent_Conditional_6_Template, 3, 2, "lg-button", 5);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddCategoryFormComponent, { className: "AddCategoryFormComponent", filePath: "src/app/features/settings/view/categories/category-product/add-category/add-category-form.component.ts", lineNumber: 62 });
})();
...
var AddCategoryComponent = class _AddCategoryComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddCategoryComponent, selectors: [["lg-add-category"]], decls: 7, vars: 3, consts: [[3, "center"], [3, "uuid"]], template: function AddCategoryComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-fade-in")(1, "lg-container")(2, "lg-gap-row", 0)(3, "lg-title");
      \u0275\u0275text(4);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(5, "lg-card");
      \u0275\u0275element(6, "lg-add-category-form", 1);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1("", ctx.uuid() ? "Edit" : "Add", " product category");
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddCategoryComponent, { className: "AddCategoryComponent", filePath: "src/app/features/settings/view/categories/category-product/add-category/add-category.component.ts", lineNumber: 39 });
})();
export {
  AddCategoryComponent
};
//# sourceMappingURL=chunk-7LSJ5UER.js.map
