...
function TabsComponent_Conditional_5_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-gap-column", 5);
...
function TabsComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, TabsComponent_Conditional_5_Conditional_0_Template, 2, 2, "lg-gap-column", 5);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
(() => {
  ...
  `, encapsulation: ViewEncapsulation.None, styles: ["/* angular:styles/component:scss;90d16b7de377856a4b1a64a091d2e9912afa8914b13d3bc8dd471cc301753e5f;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/tabs/tabs.component.ts */\n.tabs {\n  display: flex;\n  flex-direction: column;\n}\n.tabs.flat {\n  gap: 12px;\n}\n.tabs.flat .tabs__labels {\n  border-radius: 0;\n  border-bottom: none;\n  padding: 0;\n  background-color: transparent;\n}\n.tabs.flat .tabs__body {\n  border-radius: 0;\n  background-color: transparent;\n  padding: 0;\n}\n.tabs__labels {\n  display: flex;\n  gap: 8px;\n  padding: 16px;\n  background-color: #eed2f0;\n  border-bottom: 2px solid #ecc9ee;\n  overflow-x: auto;\n  white-space: nowrap;\n  scroll-behavior: smooth;\n  scroll-snap-type: x mandatory;\n  overscroll-behavior-x: contain;\n  -webkit-overflow-scrolling: touch;\n  border-radius: 12px 12px 0 0;\n}\n.tabs__labels button {\n  background: #fff;\n  border: none;\n  border-radius: 12px;\n  padding: 0.5rem 1rem;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n  font-family: inherit;\n  text-decoration: none;\n  position: relative;\n  z-index: 1;\n}\n.tabs__labels button:hover {\n  background-color: #f0f0f0;\n}\n.tabs__labels button:focus {\n  outline: 2px solid #007bff;\n}\n.tabs__labels button.active {\n  background-color: var(--accent-color);\n  color: #fff;\n}\n.tabs__body {\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n  padding: 24px 16px;\n  background-color: #fff;\n  border-radius: 0 0 12px 12px;\n}\n.tabs__body > * {\n  flex: 1;\n}\n/*# sourceMappingURL=tabs.component.css.map */\n"] }]
  }], null, { tabTemplates: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TabsComponent, { className: "TabsComponent", filePath: "src/app/shared/view/ui/tabs/tabs.component.ts", lineNumber: 134 });
})();
...
//# sourceMappingURL=chunk-KOE2WISM.js.map
