...
var CardListComponent = class _CardListComponent {
  ...
  onChanges(value, index) {
    ...
    this.onSelected.emit([value, item?.uuid || ""]);
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CardListComponent, selectors: [["lg-card-list"]], contentQueries: function CardListComponent_ContentQueries(rf, ctx, dirIndex) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(2, CardListComponent_For_3_Template, 5, 5, "div", 2, _forTrack0, false, CardListComponent_ForEmpty_4_Template, 2, 0, "div", 3);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
    ...
    ButtonComponent,
    MatIcon
  ], styles: ["/* angular:styles/component:scss;1df3aa61e0cff588fa3f44b471ca873dc33b41020ad3cac163df5e9960268cac;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/card/card-list.component.ts */\n:host {\n  display: flex;\n  width: 100%;\n}\n.lg-checkbox {\n  --control-bg: #abc2ff;\n  --control-bg-selected: #abc2ff;\n}\n.lg-card-list__inner {\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  overflow: hidden;\n  gap: 16px;\n}\n.lg-card-list__item {\n  display: flex;\n  gap: 8px;\n  align-items: center;\n}\n.lg-card-list__item__inner {\n  flex: 1;\n  overflow-x: auto;\n  display: flex;\n  align-items: center;\n  padding: 16px;\n  gap: 8px;\n  background-color: #ffffff;\n  border-radius: 32px;\n  white-space: nowrap;\n}\n.lg-card-list__item__inner > * {\n  flex: 1;\n}\n/*# sourceMappingURL=card-list.component.css.map */\n"], encapsulation: 2 });
};
(() => {
  ...
  `, encapsulation: ViewEncapsulation.None, styles: ["/* angular:styles/component:scss;1df3aa61e0cff588fa3f44b471ca873dc33b41020ad3cac163df5e9960268cac;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/card/card-list.component.ts */\n:host {\n  display: flex;\n  width: 100%;\n}\n.lg-checkbox {\n  --control-bg: #abc2ff;\n  --control-bg-selected: #abc2ff;\n}\n.lg-card-list__inner {\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  overflow: hidden;\n  gap: 16px;\n}\n.lg-card-list__item {\n  display: flex;\n  gap: 8px;\n  align-items: center;\n}\n.lg-card-list__item__inner {\n  flex: 1;\n  overflow-x: auto;\n  display: flex;\n  align-items: center;\n  padding: 16px;\n  gap: 8px;\n  background-color: #ffffff;\n  border-radius: 32px;\n  white-space: nowrap;\n}\n.lg-card-list__item__inner > * {\n  flex: 1;\n}\n/*# sourceMappingURL=card-list.component.css.map */\n"] }]
  }], () => [], { items: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CardListComponent, { className: "CardListComponent", filePath: "src/app/shared/view/ui/card/card-list.component.ts", lineNumber: 106 });
})();
...
//# sourceMappingURL=chunk-BSCLEJ6Z.js.map
