...
function CategoryRecipeListComponent_For_9_ng_template_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CategoryRecipeListComponent_For_9_ng_template_0_Template_lg_button_click_5_listener() {
      \u0275\u0275restoreView(_r1);
...
function CategoryRecipeListComponent_For_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, CategoryRecipeListComponent_For_9_ng_template_0_Template, 7, 11, "ng-template", 2);
  }
}
var CategoryRecipeListComponent = class _CategoryRecipeListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CategoryRecipeListComponent, selectors: [["lg-category-recipe-list"]], decls: 10, vars: 6, consts: [[3, "center"], [3, "flat", "link", "size"], ["lgCardListItem", ""], [1, "expand"], [3, "size", "link", "flat"], [3, "click", "size", "icon"], ["aria-hidden", "false", "aria-label", "Example home icon", "fontIcon", "close"]], template: function CategoryRecipeListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-fade-in")(1, "lg-container")(2, "lg-gap-row", 0)(3, "lg-title");
      \u0275\u0275text(4, " Recipes' categories ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "lg-button", 1);
      \u0275\u0275text(6, " Add ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "lg-card-list");
      \u0275\u0275repeaterCreate(8, CategoryRecipeListComponent_For_9_Template, 1, 0, null, 2, \u0275\u0275repeaterTrackByIndex);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CategoryRecipeListComponent, { className: "CategoryRecipeListComponent", filePath: "src/app/features/settings/view/categories/category-recipe/list/category-recipe-list.component.ts", lineNumber: 77 });
})();
export {
  CategoryRecipeListComponent
};
//# sourceMappingURL=chunk-ZLD45DMK.js.map
