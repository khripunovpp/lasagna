...
function ImportComponent_Conditional_10_Conditional_0_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-gap-column", 7)(1, "div", 8);
...
function ImportComponent_Conditional_10_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-gap-column", 7);
    \u0275\u0275repeaterCreate(1, ImportComponent_Conditional_10_Conditional_0_For_2_Template, 6, 10, "lg-gap-column", 7, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ImportComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ImportComponent_Conditional_10_Conditional_0_Template, 3, 1, "lg-gap-column", 7);
    \u0275\u0275pipe(1, "async");
  }
  if (rf & 2) {
    let tmp_3_0;
...
var ImportComponent = class _ImportComponent {
  ...
  rowsToSkip = {};
  onDone = output();
  storeName = input(null);
  schema = input();
  skipAllDuplicates = model(false);
  replaceAll = model(false);
  ...
  dialog;
  upload = viewChild(UploadComponent);
  parsedData = [];
  async onConfirm() {
  ...
  onFileSelected(file) {
    ...
    this._csvReaderService.readFromJSONFile(file[0]).then(async (data) => {
      for (const item of data) {
        ...
        await this._analyzeDuplicates(dataValidated.data).then((data2) => {
          if (data2.duplicate) {
            this.analizeSubject.next(data2.data[0]);
          } else {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ImportComponent, selectors: [["lg-import"]], contentQueries: function ImportComponent_ContentQueries(rf, ctx, dirIndex) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementStart(9, "lg-gap-column");
      \u0275\u0275conditionalCreate(10, ImportComponent_Conditional_10_Template, 2, 3);
      \u0275\u0275pipe(11, "async");
      \u0275\u0275elementStart(12, "lg-gap-row", 4)(13, "input", 5);
      ...
      \u0275\u0275pipe(16, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(17, "lg-gap-row", 4)(18, "input", 5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ImportComponent, { className: "ImportComponent", filePath: "src/app/shared/view/ui/import/import.component.ts", lineNumber: 163 });
})();
...
// src/app/features/recipes/service/Unit.scheme.ts
var UnitScheme = z.enum([
  "gram",
  "portion",
  "piece"
]);
...
function ExpanderComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ExpanderComponent_Conditional_1_Template_div_click_1_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "div", 3)(4, "lg-gap-column", 4);
    \u0275\u0275projection(5);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.closeLabel, " ");
  }
}
function ExpanderComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ExpanderComponent_Conditional_2_Template_div_click_1_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggle());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.openLabel, " ");
  }
}
var ExpanderComponent = class _ExpanderComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExpanderComponent, selectors: [["lg-expander"]], inputs: { openLabel: "openLabel", closeLabel: "closeLabel" }, ngContentSelectors: _c02, decls: 3, vars: 3, consts: [[1, "expander"], [1, "expander__header"], [1, "expander__close", 3, "click"], [1, "expander__content"], ["size", "medium"], [1, "expander__trigger", 3, "click"]], template: function ExpanderComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275conditionalCreate(1, ExpanderComponent_Conditional_1_Template, 6, 1)(2, ExpanderComponent_Conditional_2_Template, 3, 1, "div", 1);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
...
(() => {
  ...
  `, imports: [
      GapColumnComponent
    ], styles: ["/* angular:styles/component:scss;aff3fa5dcdf5b918c93bc05373b6d78bdb2de641077a5ebe485ebb5c4ca3107c;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/expander.component.ts */\n.expander {\n  display: flex;\n  flex-direction: column;\n  border-radius: 32px;\n  background-color: #fff;\n  overflow: hidden;\n}\n.expander__trigger,\n.expander__close {\n  cursor: pointer;\n}\n.expander__close {\n  text-align: right;\n}\n.expander__header {\n  padding: 24px;\n}\n.expander__content {\n  padding: 24px;\n}\n.expander.opened .expander__header {\n  background-color: var(--control-bg);\n}\n/*# sourceMappingURL=expander.component.css.map */\n"] }]
  }], () => [], { openLabel: [{
    type: Input
  }], closeLabel: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExpanderComponent, { className: "ExpanderComponent", filePath: "src/app/shared/view/ui/expander.component.ts", lineNumber: 69 });
})();
...
//# sourceMappingURL=chunk-R5ULYQ7S.js.map
