...
var environment = {
  production: true,
  demo: true,
  dbName: "lasagna-db-DEMO"
};

// src/app/shared/service/tokens/env.token.ts
var ENV_TOKEN = new InjectionToken("ENV_TOKEN", {
  factory: () => {
    return environment;
  }
});
...
var DexieIndexDbService = class _DexieIndexDbService extends import_wrapper_default {
  ...
  constructor(flexsearchIndexService) {
  ...
  async initIndex(table) {
    await this.flexsearchIndexService.initIndex(this.getStore(table), table, ["name", "uuid"]);
    ...
    if (indexData) {
      ...
      await this.getAll(table).then(async (data) => {
  ...
  async balkAdd(storeKey, values, autoUUID = true) {
    await this[storeKey].bulkPut(values.map((value) => __spreadProps(__spreadValues({}, value), {
  ...
  static \u0275fac = function DexieIndexDbService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DexieIndexDbService)(\u0275\u0275inject(FlexsearchIndexService));
  };
...
(() => {
  ...
  }], () => [{ type: FlexsearchIndexService }], null);
})();
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-UGLIF2MQ.js.map
