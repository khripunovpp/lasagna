...
function SelectionToolsComponent_Conditional_2_Conditional_2_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-button", 2);
    \u0275\u0275listener("click", function SelectionToolsComponent_Conditional_2_Conditional_2_ng_template_1_Template_lg_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.selectionZoneService.onDeleteSelected());
    });
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
...
function SelectionToolsComponent_Conditional_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SelectionToolsComponent_Conditional_2_Conditional_2_ng_template_0_Template, 3, 8, "ng-template", 0)(1, SelectionToolsComponent_Conditional_2_Conditional_2_ng_template_1_Template, 3, 8, "ng-template", 0);
  }
}
function SelectionToolsComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, SelectionToolsComponent_Conditional_2_Conditional_2_Template, 2, 0);
  }
  if (rf & 2) {
    let tmp_1_0;
...
//# sourceMappingURL=chunk-TPTHWRXS.js.map
