...
(() => {
  ...
  `, styles: ["/* angular:styles/component:scss;d779d86dc1ace29c1f89b394154904d4e5f175f60b0f8567e98ce81824b21d28;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/features/onboarding/onboarding.component.ts */\n:host {\n  display: block;\n}\n.onboarding {\n  --onboarding-bg: var(--color-bg, var(--onboarding-bg));\n  --onboarding-border: var(--color-border, var(--onboarding-border));\n}\n.onboarding__step {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  background: var(--color-bg-secondary, var(--onboarding-bg-secondary));\n  border-radius: 0.5rem;\n  padding: 1rem;\n  border: 1px solid var(--onboarding-border);\n  transition: background 0.2s;\n}\n.onboarding__step--done {\n  background: var(--color-success-bg, var(--onboarding-success-bg));\n  opacity: 0.7;\n}\n.onboarding__step--disabled {\n  background: var(--color-bg-disabled, var(--onboarding-bg-disabled));\n  opacity: 0.5;\n}\n.onboarding__step-content {\n  display: flex;\n  flex-direction: column;\n  gap: 0.25rem;\n}\n.onboarding__step-label {\n  font-weight: 600;\n  font-size: 1.1rem;\n}\n.onboarding__step-desc {\n  font-size: 0.95rem;\n  color: var(--color-text-secondary, var(--onboarding-text-secondary));\n}\n/*# sourceMappingURL=onboarding.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OnboardingComponent, { className: "OnboardingComponent", filePath: "src/app/features/onboarding/onboarding.component.ts", lineNumber: 107 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ApplicationComponent, { className: "ApplicationComponent", filePath: "src/app/shared/view/application/application.component.ts", lineNumber: 40 });
})();
export {
  ApplicationComponent
};
//# sourceMappingURL=chunk-UFBL72H3.js.map
