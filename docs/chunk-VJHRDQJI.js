...
var MultiselectComponent = class _MultiselectComponent {
  ...
  compareWith = (a, b) => {
    const valA = a;
    const valB = b;
    return valA?.uuid === valB || valA === valB || valA?.uuid === valB?.uuid || valA === valB?.uuid;
  };
  writeValue(value) {
    this.change(value);
  ...
  }, inputs: { placeholder: "placeholder", resource: [1, "resource"], appendTo: [1, "appendTo"], autoLoad: [1, "autoLoad"], multi: [1, "multi"] }, outputs: { onSelected: "onSelected" }, features: [\u0275\u0275ProvidersFeature([
    {
      provide: NG_VALUE_ACCESSOR,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MultiselectComponent, { className: "MultiselectComponent", filePath: "src/app/shared/view/ui/form/multiselect.component.ts", lineNumber: 119 });
})();
...
//# sourceMappingURL=chunk-VJHRDQJI.js.map
