import {
  TabDirective,
  TabsComponent
} from "./chunk-AIZ4ZD2Y.js";
import {
  ControlBoxComponent,
  TaxesSettingsComponent
} from "./chunk-WHZZPDTE.js";
import {
  SelfEndDirective
} from "./chunk-666FRKN2.js";
import "./chunk-2F4SUGZC.js";
import {
...
import "./chunk-WYYB64AD.js";
import {
  ControlComponent
} from "./chunk-MIHJPSYK.js";
import "./chunk-E4VJ6P46.js";
...
var CurrencySelectComponent = class _CurrencySelectComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CurrencySelectComponent, selectors: [["lg-currency-select"]], inputs: { lang: [1, "lang"], selectedCurrency: [1, "selectedCurrency"] }, outputs: { selectedCurrency: "selectedCurrencyChange" }, features: [\u0275\u0275ProvidersFeature([
  ...
  ])], decls: 4, vars: 9, consts: [["lgExpand", "", 3, "label"], ["compareField", "code", 3, "onSelected", "multi", "ngModel", "placeholder", "staticItems"]], template: function CurrencySelectComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("multi", false)("ngModel", ctx.selectedCurrency())("placeholder", \u0275\u0275pipeBind1(3, 7, "currency.select-placeholder"))("staticItems", ctx.currencyList);
    }
  }, dependencies: [
    CommonModule,
    ReactiveFormsModule,
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:scss;9a0a21e90ab79c284c79806976fd6bae326f23d0aeabbae960b7b6c7d84c43d4;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/features/controls/form/currency-select.component.ts */\n:host {\n  display: flex;\n  flex: 1;\n}\n/*# sourceMappingURL=currency-select.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CurrencySelectComponent, { className: "CurrencySelectComponent", filePath: "src/app/features/controls/form/currency-select.component.ts", lineNumber: 54 });
})();
...
var BackupSettingsComponent = class _BackupSettingsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BackupSettingsComponent, selectors: [["lg-backup-settings"]], decls: 31, vars: 36, consts: [[3, "center", "mobileMode"], ["lgSelfStart", "", 3, "click"], [3, "filesSelected", "accept"], [2, "--card-bg", "#e78888"], [3, "position"], [1, "text-center", "text-inverse"], [2, "--card-bg", "#fcd9b5"], [1, "text-center"], [3, "click"]], template: function BackupSettingsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(22, "translate");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(23, "lg-card", 3)(24, "lg-flex-column", 4)(25, "div", 7);
      \u0275\u0275text(26);
      \u0275\u0275pipe(27, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(28, "lg-button", 8);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 24, "backup.restore-informer"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275styleMap("danger");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(14, 26, "backup.restore-btn"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("position", "center");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(19, 28, "backup.flush-informer"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275styleMap("success");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(22, 30, "backup.flush-btn"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("position", "center");
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BackupSettingsComponent, { className: "BackupSettingsComponent", filePath: "src/app/features/settings/view/backup/backup-settings.component.ts", lineNumber: 85 });
})();
...
var FileInputComponent = class _FileInputComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FileInputComponent, selectors: [["lg-file-input"]], viewQuery: function FileInputComponent_Query(rf, ctx) {
    ...
    multi: true
  }])], ngContentSelectors: _c2, decls: 9, vars: 15, consts: [["fileInput", ""], [1, "lg-file-input"], ["type", "file", 1, "hidden-input", 3, "change", "disabled"], ["size", "small", 3, "onClick", "disabled", "outlined"], [1, "lg-file-input__after"], ["class", "error-message", 4, "ngIf"], [1, "error-message"]], template: function FileInputComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275projectionDef(_c1);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FileInputComponent, { className: "FileInputComponent", filePath: "src/app/features/controls/form/file-input.component.ts", lineNumber: 74 });
})();
...
var InvoicesSettingsComponent = class _InvoicesSettingsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InvoicesSettingsComponent, selectors: [["lg-invoices-settings"]], decls: 19, vars: 23, consts: [["size", "medium", 3, "formGroup"], [3, "label"], [1, "lg-invoices-settings__logo"], ["formControlName", "logo", 3, "buttonStyle", "buttonText"], ["formControlName", "prefix"], ["formControlName", "precisionRows"], ["formControlName", "precisionTotals"], ["alt", "Logo", 3, "src"]], template: function InvoicesSettingsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-flex-column", 0)(1, "lg-control", 1);
      \u0275\u0275pipe(2, "translate");
      ...
      \u0275\u0275pipe(11, "translate");
      \u0275\u0275elementStart(12, "lg-flex-row")(13, "lg-control", 1);
      \u0275\u0275pipe(14, "translate");
      \u0275\u0275element(15, "lg-number-input", 5);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "lg-control", 1);
      \u0275\u0275pipe(17, "translate");
      \u0275\u0275element(18, "lg-number-input", 6);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275property("formGroup", ctx.form);
      \u0275\u0275advance();
      \u0275\u0275property("label", \u0275\u0275pipeBind1(2, 9, "settings.invoices.logo"));
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.logoBase64() ? 3 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("buttonStyle", ctx.logoBase64() ? "danger" : "default")("buttonText", ctx.logoBase64() ? \u0275\u0275pipeBind1(5, 11, "settings.invoices.replace-logo") : \u0275\u0275pipeBind1(6, 13, "settings.invoices.upload-logo"));
      \u0275\u0275advance(3);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(8, 15, "settings.invoices.prefix"));
      \u0275\u0275advance(3);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(11, 17, "settings.invoices.precision"));
      \u0275\u0275advance(3);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(14, 19, "settings.invoices.precision-rows"));
      \u0275\u0275advance(3);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(17, 21, "settings.invoices.precision-totals"));
    }
  }, dependencies: [
    FlexColumnComponent,
    InputComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InvoicesSettingsComponent, { className: "InvoicesSettingsComponent", filePath: "src/app/features/settings/view/finance-settings/invoices-settings/invoices-settings.component.ts", lineNumber: 80 });
})();
...
function CreateCredentialComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "lg-flex-row", 4)(1, "lg-button", 26);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 11, "settings.credentials.add-row"), " ");
  }
}
var CreateCredentialComponent = class _CreateCredentialComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CreateCredentialComponent, selectors: [["lg-create-credential"]], inputs: { type: [1, "type"] }, decls: 7, vars: 3, consts: [["rowTpl", ""], [3, "formGroup"], ["formArrayName", "rows"], ["position", "center", "size", "medium"], ["size", "medium", 3, "mobileMode", "top"], [1, "credentials", 3, "formGroupName"], [1, "credentials__row", 3, "credentials__row--odd"], ["color", "#fafafa", "lgExpand", "", "size", "2"], [2, "--control-bg", "white"], [4, "ngTemplateOutlet"], [1, "credentials__row"], [3, "bottom"], ["size", "small", "lgExpand", ""], [3, "mobileMode"], [3, "label"], ["placeholder", "", "formControlName", "privateName"], ["size", "small", 3, "equal", "mobileMode"], ["formControlName", "name", "placeholder", ""], ["formControlName", "taxId", "placeholder", ""], ["formControlName", "country", "placeholder", ""], ["formControlName", "address", "placeholder", ""], ["formControlName", "phone", "type", "tel", "placeholder", ""], ["formControlName", "email", "type", "email", "placeholder", ""], ["lgSelfEnd", "", "lgShrink", "", 3, "click", "icon", "size"], ["aria-hidden", "false", "aria-label", "Delete", "fontIcon", "close"], [3, "click", "size"], ["lgShrink", "", 3, "click", "disabled"], ["lgShrink", "", 3, "click", "outlined"], ["aria-hidden", "false", "fontIcon", "add", 3, "inline"]], template: function CreateCredentialComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementContainerEnd()();
      \u0275\u0275conditionalCreate(6, CreateCredentialComponent_Conditional_6_Template, 8, 13, "lg-flex-row", 4);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CreateCredentialComponent, { className: "CreateCredentialComponent", filePath: "src/app/features/settings/view/finance-settings/credentials/create-credential.component.ts", lineNumber: 192 });
})();
...
var CredentialSettingsComponent = class _CredentialSettingsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CredentialSettingsComponent, selectors: [["lg-credentials-settings"]], decls: 5, vars: 9, consts: [[3, "flat", "scrollable", "silent"], ["alias", "system", "lgTab", "", 3, "label"], ["alias", "customers", "lgTab", "", 3, "label"], [3, "type"]], template: function CredentialSettingsComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("label", \u0275\u0275pipeBind1(2, 5, "settings.credentials.system"));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(4, 7, "settings.credentials.customer"));
    }
  }, dependencies: [
    TabsComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CredentialSettingsComponent, { className: "CredentialSettingsComponent", filePath: "src/app/features/settings/view/finance-settings/credentials/credential-settings.component.ts", lineNumber: 34 });
})();
...
function SettingsComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-flex-row", 4)(1, "a", 5);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
...
var SettingsComponent = class _SettingsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SettingsComponent, selectors: [["lg-settings"]], decls: 14, vars: 19, consts: [["alias", "language", "lgTab", "", 3, "label"], ["alias", "categoires", "lgTab", "", 3, "label"], ["alias", "backup", "lgTab", "", 3, "label"], ["alias", "logs", "lgTab", "", 3, "label"], [3, "mobileMode", "top"], ["lgExpand", "", "routerLink", "/settings/categories/products", "routerLinkActive", "active"], ["lgExpand", "", "routerLink", "/settings/categories/recipes", "routerLinkActive", "active"]], template: function SettingsComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 9, "settings.title"));
      \u0275\u0275advance(3);
      \u0275\u0275property("label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(7, 11, "language.settings-title")));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(9, 13, "categories.settings-title")));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(11, 15, "backup.settings-title")));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275interpolate(\u0275\u0275pipeBind1(13, 17, "log-center.title")));
    }
  }, dependencies: [
    ContainerComponent,
    FlexRowComponent,
...
//# sourceMappingURL=chunk-4UQBFXEM.js.map
