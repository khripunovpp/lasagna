...
(() => {
  ...
  }], () => [], { mode: [{ type: Input, args: [{ isSignal: true, alias: "mode", required: false }] }], selectAll: [{ type: Input, args: [{ isSignal: true, alias: "selectAll", required: false }] }], deselectAll: [{ type: Input, args: [{ isSignal: true, alias: "deselectAll", required: false }] }], onSelected: [{ type: Output, args: ["onSelected"] }], onDeleteOne: [{ type: Output, args: ["onDeleteOne"] }], items: [{
...
//# sourceMappingURL=chunk-G5EJUL2A.js.map
