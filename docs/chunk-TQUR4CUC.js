...
(() => {
  ...
  `, encapsulation: ViewEncapsulation.None, styles: ["/* angular:styles/component:scss;82ed64766eb9bcbe9710b7d19f63a83ab64db9d8be7bd746b26bc58ad65019fe;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/tabs/tabs.component.ts */\n.tabs {\n  display: flex;\n  flex-direction: column;\n}\n.tabs.flat {\n  gap: 12px;\n  margin: -2px;\n}\n.tabs.scrollable .tabs__labels {\n  overflow-x: auto;\n  white-space: nowrap;\n  scroll-behavior: smooth;\n  scroll-snap-type: x mandatory;\n  overscroll-behavior-x: contain;\n  -webkit-overflow-scrolling: touch;\n}\n.tabs.flat .tabs__labels {\n  border-radius: 0;\n  border-bottom: 1px solid #f5f5f5;\n  padding: 2px 2px 12px;\n  background-color: transparent;\n}\n.tabs__labels {\n  display: flex;\n  gap: 8px;\n  padding: 16px;\n  background-color: var(--tabs-labels-bg);\n  border-radius: 32px 32px 0 0;\n  border-bottom: 1px solid #ececec;\n}\n.tabs__labels button {\n  background: var(--tabs-label-bg);\n  border: 1px solid transparent;\n  border-radius: 16px;\n  padding: 12px;\n  cursor: pointer;\n  font-size: 14px;\n  transition: background-color 0.3s ease;\n  font-family: inherit;\n  text-decoration: none;\n  position: relative;\n  z-index: 1;\n}\n.tabs__labels button:hover {\n  background-color: var(--tabs-label-hover-bg);\n}\n.tabs__labels button:focus {\n  outline: 2px solid var(--tabs-label-focus);\n}\n.tabs__labels button.active {\n  background-color: var(--tabs-label-active-bg);\n  color: var(--tabs-label-active-text);\n}\n.tabs.flat .tabs__labels button {\n  padding: 8px 12px;\n  border-radius: 10px;\n}\n.tabs.flat .tabs__labels button:not(.active) {\n  background-color: transparent;\n  color: var(--tabs-label-flat-text);\n}\n.tabs.flat .tabs__labels button:not(.active):hover {\n  background-color: var(--tabs-label-flat-active-hover-bg);\n}\n.tabs.flat .tabs__labels button.active {\n  background-color: var(--tabs-label-flat-active-bg);\n  color: var(--tabs-label-flat-text);\n}\n.tabs__body {\n  display: flex;\n  flex-direction: column;\n  padding: 16px;\n  background-color: var(--tabs-body-bg);\n  border-radius: 0 0 32px 32px;\n}\n.tabs__body > * {\n  flex: 1;\n}\n.tabs.flat .tabs__body {\n  border-radius: 0;\n  background-color: transparent;\n  padding: 0;\n}\n/*# sourceMappingURL=tabs.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TabsComponent, { className: "TabsComponent", filePath: "src/app/shared/view/ui/tabs/tabs.component.ts", lineNumber: 151 });
})();
...
//# sourceMappingURL=chunk-TQUR4CUC.js.map
