...
function LastEditedRecipesComponent_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-flex-row", 2)(1, "a", 4);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
var LastEditedRecipesComponent = class _LastEditedRecipesComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LastEditedRecipesComponent, selectors: [["lg-last-edited-recipes"]], decls: 8, vars: 6, consts: [[3, "level"], [3, "size"], [3, "center", "size", "mobileMode"], [1, "last-edited-recipe-name"], [1, "last-edited-recipe", 3, "routerLink"], ["lgPull", "", 1, "text-muted", "text-cursive"]], template: function LastEditedRecipesComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-flex-column")(1, "lg-title", 0);
      \u0275\u0275text(2);
      \u0275\u0275pipe(3, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "lg-flex-column", 1);
      \u0275\u0275repeaterCreate(5, LastEditedRecipesComponent_For_6_Template, 6, 10, "lg-flex-row", 2, _forTrack0, false, LastEditedRecipesComponent_ForEmpty_7_Template, 3, 3, "div", 3);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
var LastEditedProductsComponent = class _LastEditedProductsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LastEditedProductsComponent, selectors: [["lg-last-edited-products"]], decls: 9, vars: 6, consts: [[3, "level"], [1, "last-edited-recipes"], [3, "size"], [3, "center", "size", "mobileMode"], [1, "last-edited-recipe-name"], [1, "last-edited-product", 3, "routerLink"], ["lgPull", "", 1, "text-muted", "text-cursive"]], template: function LastEditedProductsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(3, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 1)(5, "lg-flex-column", 2);
      \u0275\u0275repeaterCreate(6, LastEditedProductsComponent_For_7_Template, 6, 10, "lg-flex-row", 3, _forTrack02, false, LastEditedProductsComponent_ForEmpty_8_Template, 3, 3, "div", 4);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
(() => {
  ...
  `, standalone: true, imports: [
      ...
      PullDirective,
      TranslatePipe
    ], styles: ["/* angular:styles/component:scss;fd4110a686213ca38958bccd5259b139826bf60ce6ef84cb199ef0dbbe65aacb;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/features/home/view/last-edited-products/last-edited-products.component.ts */\n:host {\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n}\n/*# sourceMappingURL=last-edited-products.component.css.map */\n"] }]
  }], () => [{ type: ProductsRepository }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LastEditedProductsComponent, { className: "LastEditedProductsComponent", filePath: "src/app/features/home/view/last-edited-products/last-edited-products.component.ts", lineNumber: 60 });
})();

// src/app/features/onboarding/onboarding.component.ts
var _forTrack03 = ($index, $item) => $item.key;
function OnboardingComponent_Conditional_0_For_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "lg-button", 9);
    \u0275\u0275listener("onClick", function OnboardingComponent_Conditional_0_For_10_Template_lg_button_onClick_8_listener() {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 8, step_r2.label));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 10, step_r2.description));
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !step_r2.done && !ctx_r2.isCurrentStep(step_r2));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", step_r2.done ? \u0275\u0275pipeBind1(10, 12, "onboarding.done") : ctx_r2.isCurrentStep(step_r2) ? \u0275\u0275pipeBind1(11, 14, "onboarding.go") : \u0275\u0275pipeBind1(12, 16, "onboarding.unavailable"), " ");
  }
}
function OnboardingComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 0)(1, "lg-flex-column")(2, "lg-title", 1);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "lg-flex-column", 3);
    \u0275\u0275repeaterCreate(9, OnboardingComponent_Conditional_0_For_10_Template, 13, 18, "div", 4, _forTrack03);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("level", 4);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 4, "onboarding.title"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 6, "onboarding.welcome"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("size", "medium");
    \u0275\u0275advance();
...
var OnboardingComponent = class _OnboardingComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OnboardingComponent, selectors: [["lg-onboarding"]], decls: 1, vars: 1, consts: [[1, "onboarding"], [3, "level"], [1, "no-margin"], [3, "size"], [1, "onboarding__step", 3, "onboarding__step--done", "onboarding__step--disabled"], [1, "onboarding__step"], [1, "onboarding__step-content"], [1, "onboarding__step-label"], [1, "onboarding__step-desc"], [3, "onClick", "disabled"]], template: function OnboardingComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, OnboardingComponent_Conditional_0_Template, 11, 8, "section", 0);
    }
    if (rf & 2) {
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:scss;33bbc7848769e69aea7a1df553ee1bda11fe789e8c74f79734e9f4c4c53ed831;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/features/onboarding/onboarding.component.ts */\n:host {\n  display: block;\n}\n.onboarding {\n  --onboarding-bg: var(--color-bg, var(--onboarding-bg));\n  --onboarding-border: var(--color-border, var(--onboarding-border));\n}\n.onboarding__step {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 8px;\n  background: var(--color-bg-secondary, var(--onboarding-bg-secondary));\n  border-radius: 0.5rem;\n  padding: 1rem;\n  border: 1px solid var(--onboarding-border);\n  transition: background 0.2s;\n}\n@media screen and (max-width: 600px) {\n  .onboarding__step {\n    flex-direction: column;\n  }\n  .onboarding__step lg-button {\n    align-self: flex-end;\n  }\n}\n.onboarding__step--done {\n  background: var(--color-success-bg, var(--onboarding-success-bg));\n  opacity: 0.7;\n}\n.onboarding__step--disabled {\n  background: var(--color-bg-disabled, var(--onboarding-bg-disabled));\n  opacity: 0.5;\n}\n.onboarding__step-content {\n  display: flex;\n  flex-direction: column;\n  gap: 0.25rem;\n}\n.onboarding__step-label {\n  font-weight: 600;\n  font-size: 1.1rem;\n}\n.onboarding__step-desc {\n  font-size: 0.95rem;\n  color: var(--color-text-secondary, var(--onboarding-text-secondary));\n}\n/*# sourceMappingURL=onboarding.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OnboardingComponent, { className: "OnboardingComponent", filePath: "src/app/features/onboarding/onboarding.component.ts", lineNumber: 116 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ApplicationComponent, { className: "ApplicationComponent", filePath: "src/app/features/home/view/application/application.component.ts", lineNumber: 34 });
})();
export {
  ApplicationComponent
};
//# sourceMappingURL=chunk-HSRK6TFP.js.map
