...
var TabsComponent = class _TabsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TabsComponent, selectors: [["lg-tabs"]], contentQueries: function TabsComponent_ContentQueries(rf, ctx, dirIndex) {
  ...
  }, inputs: { flat: [1, "flat"], silent: [1, "silent"], scrollable: [1, "scrollable"] }, decls: 6, vars: 7, consts: [[1, "tabs"], [1, "tabs__labels"], [3, "active"], [1, "tabs__body"], [3, "click"], [3, "size"], [4, "ngTemplateOutlet"]], template: function TabsComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      \u0275\u0275classProp("scrollable", ctx.scrollable())("flat", ctx.flat());
...
(() => {
  ...
  `, encapsulation: ViewEncapsulation.None, styles: ["/* angular:styles/component:scss;d338a1d8677004110e0a589b1ea8e4f86473e29201d43d4b75bf2d5b93718413;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/tabs/tabs.component.ts */\n.tabs {\n  display: flex;\n  flex-direction: column;\n}\n.tabs.flat {\n  gap: 12px;\n  margin: -2px;\n}\n.tabs.scrollable .tabs__labels {\n  overflow-x: auto;\n  white-space: nowrap;\n  scroll-behavior: smooth;\n  scroll-snap-type: x mandatory;\n  overscroll-behavior-x: contain;\n  -webkit-overflow-scrolling: touch;\n}\n.tabs.flat .tabs__labels {\n  border-radius: 0;\n  border-bottom: none;\n  padding: 2px;\n  background-color: transparent;\n}\n.tabs.flat .tabs__body {\n  border-radius: 0;\n  background-color: transparent;\n  padding: 0;\n}\n.tabs.flat .tabs__labels button:not(.active) {\n  background-color: #efefef;\n}\n.tabs__labels {\n  display: flex;\n  gap: 8px;\n  padding: 16px;\n  background-color: var(--tabs-labels-bg);\n  border-radius: 32px 32px 0 0;\n}\n.tabs__labels button {\n  background: var(--tabs-label-bg);\n  border: 1px solid transparent;\n  border-radius: 16px;\n  padding: 12px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n  font-family: inherit;\n  text-decoration: none;\n  position: relative;\n  z-index: 1;\n}\n.tabs__labels button:hover {\n  background-color: var(--tabs-label-hover-bg);\n}\n.tabs__labels button:focus {\n  outline: 2px solid var(--tabs-label-focus);\n}\n.tabs__labels button.active {\n  background-color: var(--tabs-label-active-bg);\n  color: var(--tabs-label-active-text);\n}\n.tabs.flat .tabs__labels button:not(.active) {\n  background-color: transparent;\n  color: var(--tabs-label-flat-text);\n}\n.tabs.flat .tabs__labels button.active {\n  background-color: #fff;\n  border-color: var(--tabs-label-active-bg);\n  color: var(--tabs-label-flat-text);\n}\n.tabs__body {\n  display: flex;\n  flex-direction: column;\n  padding: 16px;\n  background-color: var(--tabs-body-bg);\n  border-radius: 0 0 32px 32px;\n}\n.tabs__body > * {\n  flex: 1;\n}\n/*# sourceMappingURL=tabs.component.css.map */\n"] }]
  }], null, { tabTemplates: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TabsComponent, { className: "TabsComponent", filePath: "src/app/shared/view/ui/tabs/tabs.component.ts", lineNumber: 153 });
})();
...
//# sourceMappingURL=chunk-43GYA55J.js.map
