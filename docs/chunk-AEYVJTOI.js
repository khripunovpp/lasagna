import {
  EggsWidgetComponent
} from "./chunk-27QURH5K.js";
import {
  TabDirective,
  TabsComponent
} from "./chunk-Y4VKNV4O.js";
import {
  InputComponent
...
function BarcodeSeekerWidgetComponent_Conditional_5_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-flex-column", 0)(1, "lg-control", 6);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementStart(3, "lg-input", 4);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function BarcodeSeekerWidgetComponent_Conditional_5_Conditional_11_Template_lg_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r3);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "lg-control", 6);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementStart(7, "lg-number-input", 4);
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function BarcodeSeekerWidgetComponent_Conditional_5_Conditional_11_Template_lg_number_input_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "lg-control", 6);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementStart(11, "lg-number-input", 4);
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function BarcodeSeekerWidgetComponent_Conditional_5_Conditional_11_Template_lg_number_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "lg-button", 7);
    \u0275\u0275listener("click", function BarcodeSeekerWidgetComponent_Conditional_5_Conditional_11_Template_lg_button_click_15_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("label", \u0275\u0275pipeBind1(2, 12, "widgets.barcode.name"));
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.product.name);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(4, 14, "widgets.barcode.name"));
    \u0275\u0275advance(2);
    \u0275\u0275property("label", \u0275\u0275pipeBind1(6, 16, "widgets.barcode.amount"));
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.product.amount);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 18, "widgets.barcode.amount"));
    \u0275\u0275advance(2);
    \u0275\u0275property("label", \u0275\u0275pipeBind1(10, 20, "widgets.barcode.price"));
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.product.price);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(12, 22, "widgets.barcode.price"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.product.unit);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(17, 24, "widgets.barcode.add-product"));
  }
}
function BarcodeSeekerWidgetComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(0, "video", 2);
    \u0275\u0275elementStart(1, "lg-flex-column")(2, "lg-flex-row", 3)(3, "lg-input", 4);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function BarcodeSeekerWidgetComponent_Conditional_5_Template_lg_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function BarcodeSeekerWidgetComponent_Conditional_5_Template_lg_button_click_5_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "lg-button", 5);
    \u0275\u0275listener("click", function BarcodeSeekerWidgetComponent_Conditional_5_Template_lg_button_click_8_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(11, BarcodeSeekerWidgetComponent_Conditional_5_Conditional_11_Template, 18, 26, "lg-flex-column", 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(4, 5, "widgets.barcode.placeholder"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 7, "widgets.barcode.search"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(10, 9, "widgets.barcode.clear"));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.showProductForm() && ctx_r1.productResult() ? 11 : -1);
  }
}
function BarcodeSeekerWidgetComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-button", 5);
    \u0275\u0275listener("click", function BarcodeSeekerWidgetComponent_Conditional_6_Template_lg_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 1, "widgets.barcode.scan"));
  }
}
var BarcodeSeekerWidgetComponent = class _BarcodeSeekerWidgetComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BarcodeSeekerWidgetComponent, selectors: [["lg-barcode-add-product-widget"]], inputs: { showFormInitially: [1, "showFormInitially"], showScanerInitially: [1, "showScanerInitially"] }, outputs: { productAdded: "productAdded" }, features: [\u0275\u0275ProvidersFeature([])], decls: 7, vars: 7, consts: [[3, "size"], [3, "top", "mobileMode"], ["id", "video"], ["lgExpand", ""], ["lgExpand", "", "lgParseMath", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "click"], [3, "label"], ["lgShrink", "", 3, "click"]], template: function BarcodeSeekerWidgetComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "lg-flex-column", 0)(1, "lg-title");
      \u0275\u0275text(2);
      \u0275\u0275pipe(3, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "lg-flex-row", 1);
      \u0275\u0275conditionalCreate(5, BarcodeSeekerWidgetComponent_Conditional_5_Template, 12, 11)(6, BarcodeSeekerWidgetComponent_Conditional_6_Template, 3, 3, "lg-button");
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275property("size", "medium");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" \u{1F4F7} ", \u0275\u0275pipeBind1(3, 5, "widgets.barcode.title"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("top", true)("mobileMode", true);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.showScanner() ? 5 : 6);
    }
  }, dependencies: [
    FormsModule,
    NgControlStatus,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BarcodeSeekerWidgetComponent, [{
    ...
    args: [{ selector: "lg-barcode-add-product-widget", standalone: true, imports: [
      ...
      ShrinkDirective,
      TranslatePipe
    ], providers: [], template: `<lg-flex-column [size]="'medium'">
  <lg-title>
    \u{1F4F7} {{ 'widgets.barcode.title' | translate }}
  </lg-title>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BarcodeSeekerWidgetComponent, { className: "BarcodeSeekerWidgetComponent", filePath: "src/app/shared/view/widgets/barcode-seeker/barcode-seeker.component.ts", lineNumber: 47 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ButtonsGroupComponent, { className: "ButtonsGroupComponent", filePath: "src/app/shared/view/ui/form/buttons-group.component.ts", lineNumber: 70 });
})();
...
(() => {
  ...
  `, imports: [
    ...
    ], styles: ["/* angular:styles/component:scss;40aa7aa84c02efa422a88a0257c26b90ebb0635ef5cefe34c2e5b1d11730eb4a;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/form/range.component.ts */\n.range-wrapper {\n  position: relative;\n  width: 100%;\n  padding-bottom: 30px;\n}\n.custom-range {\n  width: 100%;\n  -webkit-appearance: none;\n  background: transparent;\n  position: relative;\n  z-index: 2;\n  margin: 0;\n}\n.custom-range::-webkit-slider-runnable-track {\n  height: 6px;\n  background: var(--range-track-bg);\n  border-radius: 3px;\n}\n.custom-range::-moz-range-track {\n  height: 6px;\n  background: var(--range-track-bg);\n  border-radius: 3px;\n}\n.custom-range::-webkit-slider-thumb {\n  -webkit-appearance: none;\n  height: 20px;\n  width: 20px;\n  background: var(--accent-color);\n  border-radius: 50%;\n  margin-top: -7px;\n  cursor: pointer;\n}\n.custom-range::-moz-range-thumb {\n  height: 20px;\n  width: 20px;\n  background: var(--accent-color);\n  border-radius: 50%;\n  cursor: pointer;\n}\n.ticks {\n  position: absolute;\n  top: 28px;\n  left: 2.4%;\n  right: 2.4%;\n  height: 30px;\n  pointer-events: none;\n}\n.tick {\n  position: absolute;\n  text-align: center;\n  transform: translateX(-50%);\n}\n.tick-line {\n  width: 1px;\n  height: 10px;\n  background-color: var(--range-tick-color);\n  margin: 0 auto;\n}\n.label {\n  font-size: 10px;\n  color: var(--range-tick-color);\n  margin-top: 2px;\n  display: block;\n}\n/*# sourceMappingURL=range.component.css.map */\n"] }]
  }], () => [], { min: [{
    type: Input
  }], max: [{
    type: Input
...
function JellyWidgetComponent_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-flex-column", 9)(1, "div");
...
var JellyWidgetComponent = class _JellyWidgetComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _JellyWidgetComponent, selectors: [["lg-jelly-widget"]], decls: 30, vars: 34, consts: [[3, "formGroup"], [3, "bottom", "mobileMode"], ["formGroupName", "from"], ["formControlName", "amount", "lgParseMath", "", 3, "placeholder"], ["lgExtraTpl", "", "place", "after"], ["formControlName", "bloom", 3, "min", "max", "step", "tickInterval"], ["formControlName", "type", 3, "items"], ["formGroupName", "to"], [1, "text-center", 3, "strictCenter"], ["lgShrink", "", 3, "size", "position"], [2, "font-size", "2rem", 3, "size"]], template: function JellyWidgetComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(26, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(27, JellyWidgetComponent_Conditional_27_Template, 14, 13, "lg-flex-column", 9);
      \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(JellyWidgetComponent, { className: "JellyWidgetComponent", filePath: "src/app/shared/view/widgets/jelly-widget/jelly-widget.component.ts", lineNumber: 206 });
})();
...
function WidgetsPageComponent_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
...
var WidgetsPageComponent = class _WidgetsPageComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WidgetsPageComponent, selectors: [["lg-widgets-page"]], decls: 13, vars: 13, consts: [[3, "center"], ["alias", "jelly-calculator", "lgTab", "", 3, "label"], ["alias", "eggs-calculator", "lgTab", "", 3, "label"], ["alias", "barcode-seeker", "lgTab", "", 3, "label"]], template: function WidgetsPageComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(10, "translate");
      \u0275\u0275template(11, WidgetsPageComponent_ng_template_11_Template, 1, 0, "ng-template", 3);
      \u0275\u0275pipe(12, "translate");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 5, "widgets.page.title"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(8, 7, "widgets.page.jelly-calculator"));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(10, 9, "widgets.page.eggs-calculator"));
      \u0275\u0275advance(2);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(12, 11, "widgets.page.barcode-seeker"));
    }
  }, dependencies: [
    EggsWidgetComponent,
    ContainerComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WidgetsPageComponent, { className: "WidgetsPageComponent", filePath: "src/app/shared/view/widgets/widgets-page/widgets-page.component.ts", lineNumber: 60 });
})();
export {
  WidgetsPageComponent
};
//# sourceMappingURL=chunk-AEYVJTOI.js.map
