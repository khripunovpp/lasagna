...
import {
  RecipeScheme
} from "./chunk-MMLONZMA.js";
import "./chunk-GOI3JMTN.js";
import {
...
function AddRecipeFormComponent_For_23_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate2(" ", ctx_r3.productLabelFactory(item_r3), " / ", \u0275\u0275pipeBind2(1, 4, item_r3.pricePerUnit, ctx_r3.pipesDigits()), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("translateParams", \u0275\u0275pureFunction1(11, _c4, \u0275\u0275pipeBind1(4, 9, \u0275\u0275pipeBind1(3, 7, item_r3 == null ? null : item_r3.unit))))("translate", "per-unit.label");
  }
}
function AddRecipeFormComponent_For_23_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "userCurrency");
    \u0275\u0275element(2, "span", 36);
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275textInterpolate2(" ", ctx_r3.productLabelFactory(item_r5), " / ", \u0275\u0275pipeBind2(1, 4, item_r5.pricePerUnit, ctx_r3.pipesDigits()), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("translateParams", \u0275\u0275pureFunction1(11, _c4, \u0275\u0275pipeBind1(4, 9, \u0275\u0275pipeBind1(3, 7, item_r5 == null ? null : item_r5.unit))))("translate", "per-unit.label");
  }
}
function AddRecipeFormComponent_For_23_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "lg-unit-switcher", 37);
  }
}
function AddRecipeFormComponent_For_23_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "hr", 35);
  }
}
function AddRecipeFormComponent_For_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "lg-flex-row", 25)(2, "lg-entity-item-selector", 26);
    \u0275\u0275element(3, "lg-multiselect", 27);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementStart(5, "lg-multiselect", 28);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275template(7, AddRecipeFormComponent_For_23_ng_template_7_Template, 5, 13, "ng-template", 29)(8, AddRecipeFormComponent_For_23_ng_template_8_Template, 5, 13, "ng-template", 30);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "lg-number-input", 31, 1);
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275listener("onKeydown", function AddRecipeFormComponent_For_23_Template_lg_number_input_onKeydown_9_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.addLast());
    });
    \u0275\u0275template(13, AddRecipeFormComponent_For_23_ng_template_13_Template, 1, 0, "ng-template", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div")(15, "lg-button", 33);
    \u0275\u0275listener("click", function AddRecipeFormComponent_For_23_Template_lg_button_click_15_listener() {
      const \u0275$index_37_r6 = \u0275\u0275restoreView(_r2).$index;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.deleteIngredient(\u0275$index_37_r6));
    });
    \u0275\u0275element(16, "mat-icon", 34);
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(17, AddRecipeFormComponent_For_23_Conditional_17_Template, 1, 0, "hr", 35);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275property("formGroupName", \u0275$index_37_r6);
    \u0275\u0275advance();
    \u0275\u0275property("bottom", true)("mobileMode", true);
    \u0275\u0275advance(2);
    \u0275\u0275property("resource", "recipes")("placeholder", \u0275\u0275pipeBind1(4, 16, "invoices.find-recipe"))("autoLoad", true);
    \u0275\u0275advance(2);
    \u0275\u0275property("resource", "products")("optionFactory", ctx_r3.productLabelFactory)("placeholder", \u0275\u0275pipeBind1(6, 18, "invoices.find-product"))("autoLoad", true);
    \u0275\u0275advance(4);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind2(12, 22, "recipe.form.ingredients.amount.placeholder", \u0275\u0275pureFunction1(25, _c4, \u0275\u0275pipeBind1(11, 20, "unit.long." + ((ctx_r3.form.value.ingredients == null ? null : ctx_r3.form.value.ingredients[\u0275$index_37_r6] == null ? null : ctx_r3.form.value.ingredients[\u0275$index_37_r6].unit) || ctx_r3.UnitValue.GRAM)))));
    \u0275\u0275advance(6);
    \u0275\u0275styleMap("danger");
    \u0275\u0275property("flat", true)("icon", true);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!(\u0275$index_37_r6 === \u0275$count_37_r7 - 1) ? 17 : -1);
  }
}
function AddRecipeFormComponent_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "lg-chips-list", 24);
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    const categorySelect_r8 = \u0275\u0275reference(45);
...
var AddRecipeFormComponent = class _AddRecipeFormComponent {
  ...
  _settingsService;
  constructor(_recipesRepository, _selectResourcesService, _router, _aRoute, _notificationsService, _settingsService) {
  ...
  static \u0275fac = function AddRecipeFormComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AddRecipeFormComponent)(\u0275\u0275directiveInject(RecipesRepository), \u0275\u0275directiveInject(SelectResourcesService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(NotificationsService), \u0275\u0275directiveInject(SettingsService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddRecipeFormComponent, selectors: [["lg-add-recipe-form"]], viewQuery: function AddRecipeFormComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(22, AddRecipeFormComponent_For_23_Template, 18, 27, "ng-container", 11, _forTrack02);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275conditionalCreate(46, AddRecipeFormComponent_Conditional_46_Template, 1, 2, "lg-chips-list", 24);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.topCategories().length ? 46 : -1);
    }
  }, dependencies: [
    ReactiveFormsModule,
    \u0275NgNoValidate,
...
` }]
  }], () => [{ type: RecipesRepository }, { type: SelectResourcesService }, { type: Router }, { type: ActivatedRoute }, { type: NotificationsService }, { type: SettingsService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddRecipeFormComponent, { className: "AddRecipeFormComponent", filePath: "src/app/features/recipes/view/add-recipe/add-recipe-form.component.ts", lineNumber: 104 });
})();
...
function AddRecipeComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-controls-bar", 0)(1, "lg-button", 5);
    \u0275\u0275pipe(2, "translate");
...
function AddRecipeComponent_Conditional_5_Conditional_4_ng_template_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-fade-in")(1, "span", 12);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd()();
  }
...
function AddRecipeComponent_Conditional_5_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, AddRecipeComponent_Conditional_5_Conditional_4_ng_template_0_Template, 4, 3, "ng-template", 10);
  }
}
...
function AddRecipeComponent_Conditional_5_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, AddRecipeComponent_Conditional_5_Conditional_6_ng_template_0_Template, 3, 6, "ng-template", 10);
  }
}
...
function AddRecipeComponent_Conditional_5_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, AddRecipeComponent_Conditional_5_Conditional_7_ng_template_0_Template, 3, 6, "ng-template", 10);
  }
}
...
function AddRecipeComponent_Conditional_5_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, AddRecipeComponent_Conditional_5_Conditional_8_ng_template_0_Template, 3, 6, "ng-template", 10);
  }
}
...
function AddRecipeComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-flex-row", 8)(1, "lg-title", 9);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "lg-inline-separated-group");
    \u0275\u0275conditionalCreate(4, AddRecipeComponent_Conditional_5_Conditional_4_Template, 1, 0, null, 10);
    \u0275\u0275template(5, AddRecipeComponent_Conditional_5_ng_template_5_Template, 3, 8, "ng-template", 10);
    \u0275\u0275conditionalCreate(6, AddRecipeComponent_Conditional_5_Conditional_6_Template, 1, 0, null, 10);
    \u0275\u0275conditionalCreate(7, AddRecipeComponent_Conditional_5_Conditional_7_Template, 1, 0, null, 10)(8, AddRecipeComponent_Conditional_5_Conditional_8_Template, 1, 0, null, 10);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, AddRecipeComponent_Conditional_5_Conditional_9_Template, 4, 6, "small", 11);
  }
  if (rf & 2) {
    let tmp_3_0;
    let tmp_4_0;
...
var AddRecipeComponent = class _AddRecipeComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddRecipeComponent, selectors: [["lg-add-recipe"]], viewQuery: function AddRecipeComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275element(7, "lg-add-recipe-form", 2);
      \u0275\u0275elementStart(8, "lg-flex-row", 3);
      \u0275\u0275conditionalCreate(9, AddRecipeComponent_Conditional_9_Template, 3, 4, "lg-button", 4)(10, AddRecipeComponent_Conditional_10_Template, 3, 4, "lg-button", 4);
      \u0275\u0275elementEnd()()();
...
//# sourceMappingURL=chunk-MK63G6S7.js.map
