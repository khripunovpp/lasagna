...
function DialogComponent_Conditional_9_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-button", 12);
    \u0275\u0275listener("click", function DialogComponent_Conditional_9_Conditional_1_Template_lg_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
...
function DialogComponent_Conditional_9_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-button", 13);
    \u0275\u0275listener("click", function DialogComponent_Conditional_9_Conditional_2_Template_lg_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function DialogComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, DialogComponent_Conditional_9_Conditional_1_Template, 2, 3, "lg-button", 10);
    \u0275\u0275conditionalCreate(2, DialogComponent_Conditional_9_Conditional_2_Template, 2, 3, "lg-button", 11);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.showCancelButton() ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.showConfirmButton() ? 2 : -1);
  }
}
var DialogComponent = class _DialogComponent {
  ...
  showCancelButton = input(true, ...ngDevMode ? [{ debugName: "showCancelButton" }] : []);
  onCancel = output();
  onConfirm = output();
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DialogComponent, selectors: [["lg-dialog"]], inputs: { closeButton: [1, "closeButton"], cancelButtonText: [1, "cancelButtonText"], confirmButtonText: [1, "confirmButtonText"], confirmButtonStyle: [1, "confirmButtonStyle"], cancelButtonStyle: [1, "cancelButtonStyle"], closeOnConfirm: [1, "closeOnConfirm"], displayFooter: [1, "displayFooter"], centerButtons: [1, "centerButtons"], columnButtons: [1, "columnButtons"], showConfirmButton: [1, "showConfirmButton"], showCancelButton: [1, "showCancelButton"] }, outputs: { onCancel: "onCancel", onConfirm: "onConfirm" }, ngContentSelectors: _c0, decls: 10, vars: 4, consts: [[1, "dialog", 3, "click"], [1, "dialog__container"], [1, "dialog__wrap"], ["lgFocusTrap", "", 1, "dialog__box"], ["aria-label", "Close dialog", 1, "dialog__close-button"], [3, "click"], [1, "dialog__inner-container"], [1, "dialog__inner"], [1, "dialog__footer", 3, "column", "centered"], [1, "dialog__footer"], [1, "dialog__cancel-button", 3, "style"], [1, "dialog__confirm-button", 3, "style"], [1, "dialog__cancel-button", 3, "click"], [1, "dialog__confirm-button", 3, "click"]], template: function DialogComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275projection(8);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(9, DialogComponent_Conditional_9_Template, 3, 6, "div", 8);
      \u0275\u0275elementEnd()()()()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(5);
      \u0275\u0275conditional(ctx.displayFooter() && (ctx.showCancelButton() || ctx.showConfirmButton()) ? 9 : -1);
    }
  }, dependencies: [
    CardComponent,
    ButtonComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DialogComponent, { className: "DialogComponent", filePath: "src/app/shared/view/ui/dialogs/dialog.component.ts", lineNumber: 148 });
})();
...
//# sourceMappingURL=chunk-24I4TH52.js.map
