...
var ArticleComponent = class _ArticleComponent {
  ...
  content = defer(() => this.router.events.pipe(filter((event) => event instanceof NavigationEnd), startWith(null), switchMap(() => this._docsService.getDocs()), map((data) => ({
    ...
    const doc = data.filter((doc2) => doc2.path.includes(url || "/start-page"));
...
(() => {
  ...
  `, imports: [
      AsyncPipe
    ], styles: ["/* angular:styles/component:scss;e075a6200c15ff7eeaf84369addbf03be5bdadb73cc604faeb24acfbe0d4d6b4;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/documentation/article.component.ts */\n.lg-article {\n  display: flex;\n}\n/*# sourceMappingURL=article.component.css.map */\n"] }]
  }], () => [{ type: DocsService }, { type: ActivatedRoute }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ArticleComponent, { className: "ArticleComponent", filePath: "src/app/shared/view/documentation/article.component.ts", lineNumber: 28 });
})();
export {
  ArticleComponent
};
//# sourceMappingURL=chunk-EED6KCB6.js.map
