...
// src/app/shared/view/ui/form/chips-list.component.ts
...
(() => {
  ...
  `, providers: [
    ...
    ], imports: [], styles: ["/* angular:styles/component:scss;7777a42021a68d218ff8fb9b2102972de2059f6854fb59cb8a43fbea6e671dc0;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/form/chips-list.component.ts */\n.chips-list {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 8px;\n}\n.chip {\n  background-color: var(--chip-color);\n  color: #fff;\n  padding: 4px 8px;\n  border-radius: 16px;\n  font-size: 0.875rem;\n  display: inline-block;\n  cursor: pointer;\n  transition: all 0.2s;\n  transition-timing-function: cubic-bezier(0.47, 1.64, 0.41, 0.8);\n}\n.chip.selected {\n  opacity: 0.5;\n}\n.chip:hover {\n  transform: scale(1.1);\n}\n/*# sourceMappingURL=chips-list.component.css.map */\n"] }]
  }], () => [], { chipColor: [{
    type: HostBinding,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ChipsListComponent, { className: "ChipsListComponent", filePath: "src/app/shared/view/ui/form/chips-list.component.ts", lineNumber: 60 });
})();

// src/app/shared/view/ui/form/autocomplete.component.ts
...
var AutocompleteComponent = class _AutocompleteComponent {
  ...
  ])], decls: 5, vars: 10, consts: [[1, "autocomplete"], ["bindLabel", "name", "notFoundText", "Start typing to search", 3, "blur", "change", "search", "addTag", "bindValue", "appendTo", "compareWith", "editableSearchTerm", "items", "multiple", "ngModel", "placeholder", "searchFn"], ["ng-label-tmp", ""], ["ng-option-tmp", ""], ["ng-tag-tmp", ""]], template: function AutocompleteComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(2, AutocompleteComponent_ng_template_2_Template, 1, 1, "ng-template", 2)(3, AutocompleteComponent_ng_template_3_Template, 1, 1, "ng-template", 3)(4, AutocompleteComponent_ng_template_4_Template, 1, 1, "ng-template", 4);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275property("addTag", true)("bindValue", ctx.key())("appendTo", ctx.appendTo())("compareWith", ctx.compareWith)("editableSearchTerm", true)("items", ctx.loadedList())("multiple", ctx.multi())("ngModel", ctx.value)("placeholder", ctx.placeholder)("searchFn", ctx.searchFn);
    }
  }, dependencies: [
    NgSelectComponent,
    FormsModule,
...
(() => {
  ...
  `, imports: [
    ...
    ], encapsulation: ViewEncapsulation.None, styles: ["/* angular:styles/component:scss;8db79f2d60abff424e3e33b16f211108e837096ab2ea4478366ed98bbe3daf19;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/form/autocomplete.component.ts */\nlg-autocomplete {\n  display: flex;\n  flex: 1;\n  min-width: 150px;\n}\n.autocomplete {\n  flex: 1;\n  width: 100%;\n}\n.autocomplete .ng-select.ng-select-single .ng-select-container {\n  height: 51px;\n}\n.autocomplete .ng-select.ng-select-focused .ng-select-container {\n  outline: none;\n  box-shadow: var(--focus-shadow);\n  border-radius: 12px;\n}\n.autocomplete .ng-select .ng-select-container {\n  border: none;\n  border-radius: 12px;\n  background-color: var(--control-bg);\n}\n.autocomplete .ng-select .ng-select-container .ng-input {\n  top: 16px !important;\n  padding-right: 10px !important;\n}\n.autocomplete .ng-select .ng-select-container .ng-input > input {\n  color: var(--text);\n  font-family: inherit;\n  font-size: inherit;\n}\n.autocomplete .ng-dropdown-panel {\n  border: none;\n  box-shadow: 0 4px 16px 0 rgba(0, 0, 0, 0.1);\n  border-radius: 12px;\n  overflow: hidden;\n}\n.autocomplete .ng-dropdown-panel .ng-option {\n  padding: 16px;\n  border-radius: 12px;\n}\n.autocomplete .ng-arrow-wrapper {\n  display: none;\n}\n.autocomplete .ng-clear-wrapper {\n  display: none;\n}\n/*# sourceMappingURL=autocomplete.component.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AutocompleteComponent, { className: "AutocompleteComponent", filePath: "src/app/shared/view/ui/form/autocomplete.component.ts", lineNumber: 139 });
})();
...
//# sourceMappingURL=chunk-PKT7X36Z.js.map
