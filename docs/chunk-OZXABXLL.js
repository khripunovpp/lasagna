...
var BarcodeSeekerWidgetComponent = class _BarcodeSeekerWidgetComponent {
  ...
  productAdded = output();
  barcode = signal("", ...ngDevMode ? [{ debugName: "barcode" }] : []);
  product = {
    name: "",
    price: 0,
    amount: 0,
  ...
  lockRequest = false;
  showFormInitially = input(false, ...ngDevMode ? [{ debugName: "showFormInitially" }] : []);
  showScanerInitially = input(false, ...ngDevMode ? [{ debugName: "showScanerInitially" }] : []);
  showScanner = signal(false, ...ngDevMode ? [{ debugName: "showScanner" }] : []);
  showProductForm = signal(false, ...ngDevMode ? [{ debugName: "showProductForm" }] : []);
  ...
  productResult = computed(() => {
    ...
    return null;
  }, ...ngDevMode ? [{ debugName: "productResult" }] : []);
...
//# sourceMappingURL=chunk-OZXABXLL.js.map
