import {
  TabDirective,
  TabsComponent
} from "./chunk-7FMAXEJC.js";
import {
  ControlBoxComponent,
  SelfCenterDirective,
  SelfEndDirective,
  TaxesSettingsComponent
} from "./chunk-V2QF4GJ5.js";
import {
  matchMediaSignal,
  mobileBreakpoint
} from "./chunk-YIUZO3M7.js";
import "./chunk-YR3S4UY7.js";
...
} from "./chunk-RTGDVEAR.js";
import {
  UploadComponent
} from "./chunk-3LSKCD37.js";
import "./chunk-I2GJGW5L.js";
import "./chunk-P3UMGRZT.js";
import {
...
var CurrencySelectComponent = class _CurrencySelectComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CurrencySelectComponent, selectors: [["lg-currency-select"]], inputs: { lang: [1, "lang"], selectedCurrency: [1, "selectedCurrency"] }, outputs: { selectedCurrency: "selectedCurrencyChange" }, features: [\u0275\u0275ProvidersFeature([
  ...
  ])], decls: 9, vars: 11, consts: [[3, "size"], [3, "level"], ["href", "https://en.wikipedia.org/wiki/ISO_4217", "target", "_blank"], [3, "onSelected", "ngModelChange", "placeholder", "staticItems", "multi", "ngModel"]], template: function CurrencySelectComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6, ") ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "lg-multiselect", 3);
      \u0275\u0275pipe(8, "translate");
      \u0275\u0275listener("onSelected", function CurrencySelectComponent_Template_lg_multiselect_onSelected_7_listener($event) {
        return ctx.onCurrencySelected($event);
      });
      \u0275\u0275twoWayListener("ngModelChange", function CurrencySelectComponent_Template_lg_multiselect_ngModelChange_7_listener($event) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("level", 6);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 7, "language.settings.currency-title"), " (");
      \u0275\u0275advance(5);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 9, "currency.select-placeholder"))("staticItems", ctx.displayedCurrencies())("multi", false);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CurrencySelectComponent, { className: "CurrencySelectComponent", filePath: "src/app/shared/view/ui/form/currency-select.component.ts", lineNumber: 73 });
})();
...
//# sourceMappingURL=chunk-CEEZDVO2.js.map
