...
// src/app/shared/view/ui/layout/flex-row.component.ts
var _c0 = ["*"];
...
(() => {
  ...
  `, imports: [
      NgClass,
      NgStyle
    ], encapsulation: ViewEncapsulation.None, styles: ["/* angular:styles/component:scss;43592000edc4bc8629b11381a9bf601791fc51730d16dc24e38ad4dbbd972698;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/layout/flex-row.component.ts */\n:host {\n  flex: 1;\n  --lg-gap-row-pad-left: 0;\n  --lg-gap-row-pad-right: 0;\n}\n.gap-row {\n  display: flex;\n  --gap: 32px;\n  gap: var(--gap);\n  padding-left: var(--lg-gap-row-pad-left);\n  padding-right: var(--lg-gap-row-pad-right);\n}\n.gap-row__center {\n  align-items: center;\n}\n.gap-row__strict-center {\n  align-items: center;\n  justify-content: center;\n}\n.gap-row__bottom {\n  align-items: flex-end;\n}\n.gap-row__top {\n  align-items: flex-start;\n}\n.gap-row__right {\n  justify-content: flex-end;\n}\n.gap-row__left {\n  justify-content: flex-start;\n}\n.gap-row.small {\n  --gap: 8px;\n}\n.gap-row.medium {\n  --gap: 16px;\n}\n.gap-row.tiny {\n  --gap: 4px;\n}\n.gap-row__fit > * {\n  flex: auto;\n}\n.gap-row__equal {\n  align-items: stretch;\n}\n.gap-row__equal > * {\n  flex: 1;\n}\n.gap-row__relaxed {\n  justify-content: space-between;\n}\n.gap-row__wrap {\n  flex-wrap: wrap;\n}\n.gap-row__wrap > * {\n  flex: 0 0 calc(100% / var(--cols) - var(--gap) / var(--cols));\n}\n.gap-row__wrap.gap-row__fit > * {\n  flex: 0;\n}\n@media (max-width: 768px) {\n  .gap-row__mobile {\n    flex-direction: column;\n    --gap: 16px;\n  }\n  .gap-row__mobile.small {\n    --gap: 4px;\n  }\n  .gap-row__mobile.medium {\n    --gap: 8px;\n  }\n  .gap-row__mobile.tiny {\n    --gap: 2px;\n  }\n  .gap-row__mobileReverse {\n    flex-direction: column-reverse;\n  }\n}\n/*# sourceMappingURL=flex-row.component.css.map */\n"] }]
  }], () => [], { equal: [{
    type: Input
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FlexRowComponent, { className: "FlexRowComponent", filePath: "src/app/shared/view/ui/layout/flex-row.component.ts", lineNumber: 139 });
})();

export {
  FlexRowComponent
};
//# sourceMappingURL=chunk-O73UITIU.js.map
