...
(() => {
  ...
  `, imports: [
    ...
    type: Input
  }], labelFactory: [{ type: Input, args: [{ isSignal: true, alias: "labelFactory", required: false }] }], optionFactory: [{ type: Input, args: [{ isSignal: true, alias: "optionFactory", required: false }] }], resource: [{ type: Input, args: [{ isSignal: true, alias: "resource", required: false }] }], appendTo: [{ type: Input, args: [{ isSignal: true, alias: "appendTo", required: false }] }], compareField: [{ type: Input, args: [{ isSignal: true, alias: "compareField", required: false }] }], autoLoad: [{ type: Input, args: [{ isSignal: true, alias: "autoLoad", required: false }] }], multi: [{ type: Input, args: [{ isSignal: true, alias: "multi", required: false }] }], staticItems: [{ type: Input, args: [{ isSignal: true, alias: "staticItems", required: false }] }], onSelected: [{ type: Output, args: ["onSelected"] }], selectComponent: [{ type: ViewChild, args: [forwardRef(() => NgSelectComponent), { isSignal: true }] }], templates: [{ type: ContentChildren, args: [forwardRef(() => ControlTemplateDirective), { isSignal: true }] }] });
})();
(() => {
...
//# sourceMappingURL=chunk-IPBDTX37.js.map
