  ...
  children: [
    ...
    },
    {
      ...
      children: [
        {
          path: "",
          loadComponent: () => import("./chunk-MLRZB7OS.js").then((m) => m.ApplicationComponent),
          data: {
            canSeePolicies: true
          },
    ...
    },
    {
      ...
      children: [
        {
          path: "",
          loadComponent: () => import("./chunk-JVUVKZB5.js").then((m) => m.RecipesListComponent),
          title: defTitleResolver
        },
        {
          path: "add",
          loadComponent: () => import("./chunk-MK63G6S7.js").then((m) => m.AddRecipeComponent),
          title: defTitleResolver
        },
        {
          path: "edit/:uuid",
        ...
        {
          path: "calculate/:uuid",
          loadComponent: () => import("./chunk-DK7RDTED.js").then((m) => m.CalculateRecipeComponent),
          resolve: {
    ...
    },
    {
      ...
      children: [
        {
          path: "",
          loadComponent: () => import("./chunk-T4C6JRSN.js").then((m) => m.ProductListComponent),
          title: defTitleResolver
        },
        {
          path: "add",
          loadComponent: () => import("./chunk-BY7RSADJ.js").then((m) => m.AddProductComponent),
          title: defTitleResolver
        },
        {
          path: "edit/:uuid",
    ...
    },
    {
      ...
      children: [
        {
          path: "",
          loadComponent: () => import("./chunk-AIYQLDFH.js").then((m) => m.InvoicesListComponent),
          title: defTitleResolver
        },
        {
          path: "edit/:uuid",
          loadComponent: () => import("./chunk-PRBOTWFH.js").then((m) => m.AddInvoiceComponent),
          providers: [
            InvoiceBuilderService
          ],
          resolve: {
    ...
    },
    {
      ...
      children: [
        {
          path: "",
          loadComponent: () => import("./chunk-QCENO5WB.js").then((m) => m.SettingsComponent),
          title: defTitleResolver
        },
        {
          path: "taxes",
          children: [
            {
              path: "",
              loadComponent: () => import("./chunk-V6U3QM5D.js").then((m) => m.TaxesSettingsComponent),
              title: defTitleResolver
            }
          ]
        }
    ...
    {
      path: "widgets",
      loadComponent: () => import("./chunk-EGUWOO2J.js").then((m) => m.WidgetsPageComponent),
      title: defTitleResolver
    },
    {
      path: "docs",
      loadComponent: () => import("./chunk-SZYTBK6X.js").then((m) => m.DocumentationContainerComponent),
      title: defTitleResolver,
      children: [
        {
          path: "**",
...
(() => {
  ...
  `, imports: [
      ...
      FadeInComponent,
      NgOptimizedImage
    ], styles: ['/* angular:styles/component:scss;7c88e76978b83e1600c5dd138f6430f39f63c664268663da45e39e88d1af50d0;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/layout/header.component.ts */\n:host {\n  position: fixed;\n  z-index: 3;\n  left: 50%;\n  right: 0;\n  top: 12px;\n  transform: translateX(-50%);\n  max-width: calc(var(--container-width) + 32px);\n  width: calc(100% - 32px);\n}\n@media (max-width: 768px) {\n  :host {\n    width: 100%;\n  }\n}\n.lg-header {\n  height: var(--header-height);\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 16px;\n  overflow: hidden;\n  overflow-x: auto;\n  white-space: nowrap;\n  padding: 0 16px;\n  scroll-snap-type: x mandatory;\n}\n@media (max-width: 768px) {\n  .lg-header {\n    justify-content: normal;\n    scroll-snap-type: both mandatory;\n    overscroll-behavior-x: contain;\n    scrollbar-width: none;\n  }\n}\n.lg-header::after {\n  content: "";\n  position: absolute;\n  top: -12px;\n  left: 50%;\n  transform: translate3d(-50%, 0, 0);\n  width: 100dvw;\n  height: 100px;\n  pointer-events: none;\n  -webkit-backdrop-filter: blur(3px);\n  backdrop-filter: blur(3px);\n  z-index: -1;\n  -webkit-mask-image:\n    linear-gradient(\n      to bottom,\n      rgb(0, 0, 0) 50%,\n      rgba(0, 0, 0, 0) 100%);\n  mask-image:\n    linear-gradient(\n      to bottom,\n      rgb(0, 0, 0) 50%,\n      rgba(0, 0, 0, 0) 100%);\n  will-change: transform;\n}\n.lg-header__left,\n.lg-header__right,\n.lg-header__leftToMiddle,\n.lg-header__rightToMiddle,\n.lg-header__middle {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  scroll-snap-align: center;\n  gap: 8px;\n  min-width: 40px;\n}\n@media (max-width: 768px) {\n  .lg-header__left,\n  .lg-header__right,\n  .lg-header__leftToMiddle,\n  .lg-header__rightToMiddle,\n  .lg-header__middle {\n    flex: 0 0 auto;\n    min-width: 0;\n  }\n}\n.lg-header__leftToMiddle {\n  margin-left: auto;\n}\n.lg-header__rightToMiddle {\n  margin-right: auto;\n}\n.lg-header__inner {\n  display: flex;\n  border-radius: 35px;\n  padding: 8px;\n  -webkit-backdrop-filter: blur(3px);\n  backdrop-filter: blur(3px);\n  background-color: rgba(255, 255, 255, 0.7);\n}\n.lg-header__link {\n  font-size: 1rem;\n  font-family: inherit;\n  text-decoration: none;\n  padding: 8px 24px;\n  border-radius: 32px;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  scroll-snap-align: center;\n  transition: all 0.3s ease-in-out;\n  appearance: none;\n}\n.lg-header__link.route-active {\n  background-color: var(--header-active-bg);\n  color: #fff;\n}\n.lg-header__icon {\n  border-radius: 50%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 8px;\n  cursor: pointer;\n  scroll-snap-align: center;\n  border: none;\n  appearance: none;\n  -webkit-backdrop-filter: blur(3px);\n  backdrop-filter: blur(3px);\n  background-color: rgba(255, 255, 255, 0.7);\n  color: inherit;\n}\n.lg-header__logo {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.lg-header__icon.route-active {\n  background-color: var(--header-active-bg);\n  color: #fff;\n}\n/*# sourceMappingURL=header.component.css.map */\n'] }]
