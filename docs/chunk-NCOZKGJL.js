...
(() => {
  ...
  `, standalone: true, imports: [], animations: [
    ...
    ], styles: ["/* angular:styles/component:scss;8e905d81e67c388faca783339276b7a77891ecaaa8e24d63feece24df5035726;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/shared/view/ui/controls-bar/controls-bar.component.ts */\n.lg-controls-bar {\n  position: fixed;\n  z-index: 5;\n  right: 50%;\n  bottom: var(--controls-bar-shift, 0);\n  transform: translateX(50%);\n  max-width: 90%;\n  width: max-content;\n  display: flex;\n  gap: 6px;\n  border-radius: 100px;\n  -webkit-backdrop-filter: blur(4px);\n  backdrop-filter: blur(4px);\n  background-color: rgba(255, 255, 255, 0.8);\n  padding: 10px;\n  align-items: center;\n  justify-content: center;\n  box-shadow: 0px -9px 80px 30px rgba(143, 143, 143, 0.1);\n}\n.lg-controls-bar--large {\n  padding: 12px;\n}\n.lg-controls-bar--small {\n  padding: 8px;\n}\n.lg-controls-bar__content {\n  display: flex;\n  align-items: center;\n  position: relative;\n  gap: 12px;\n  white-space: nowrap;\n}\n/*# sourceMappingURL=controls-bar.component.css.map */\n"] }]
  }], null, { bottomPosition: [{
    type: HostBinding,
...
//# sourceMappingURL=chunk-NCOZKGJL.js.map
