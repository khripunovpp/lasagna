...
(() => {
  ...
  `, imports: [
    ...
    type: SkipSelf
  }] }], { key: [{ type: Input, args: [{ isSignal: true, alias: "key", required: false }] }], data: [{ type: Input, args: [{ isSignal: true, alias: "data", required: false }] }], items: [{
...
function GroupingTilesComponent_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.groupingTileDirective() && ctx_r2.collapsedStates()[\u0275$index_3_r2] ? 6 : -1);
  }
}
...
(() => {
  ...
  `, imports: [
    ...
    type: Optional
  }] }, { type: TranslateService }, { type: Router }, { type: ViewportScroller }], { sortResult: [{ type: Input, args: [{ isSignal: true, alias: "sortResult", required: false }] }], selectable: [{ type: Input, args: [{ isSignal: true, alias: "selectable", required: false }] }], groupingTileDirective: [{ type: ContentChild, args: [forwardRef(() => GroupingTileDirective), { isSignal: true }] }], groupingHeaderDirective: [{ type: ContentChild, args: [forwardRef(() => GroupingHeaderDirective), { isSignal: true }] }] });
})();
(() => {
...
//# sourceMappingURL=chunk-PVQCZ74O.js.map
