...
(() => {
  ...
  `, styles: ["/* angular:styles/component:scss;8ceb84cd2997b24e01afe66158c8310aebfc9a9cf678a556dbd8fda32d27ee07;/Users/khripunovpavel/Documents/my/lasagna/lasagna/src/app/features/controls/form/control-group.component.ts */\n:host {\n  display: flex;\n  flex: 1;\n}\n.control-group {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n}\n.control-group__label {\n  font-size: 1.2rem;\n  margin: 0;\n}\n.control-group__content {\n  display: flex;\n  gap: 8px;\n  align-items: flex-end;\n}\n.control-group__content > * {\n  flex: 1;\n}\n/*# sourceMappingURL=control-group.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ControlGroupComponent, { className: "ControlGroupComponent", filePath: "src/app/features/controls/form/control-group.component.ts", lineNumber: 47 });
})();
...
function AddRecipeFormComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "lg-unit-switcher", 23);
  }
}
function AddRecipeFormComponent_For_23_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "lg-unit-switcher", 34);
  }
}
function AddRecipeFormComponent_For_23_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "hr", 33);
  }
}
function AddRecipeFormComponent_For_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "lg-controls-row", 24)(2, "lg-flex-column", 25)(3, "lg-entity-item-selector", 26);
    \u0275\u0275element(4, "lg-multiselect", 27);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275element(6, "lg-multiselect", 28);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "lg-number-input", 29, 1);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275listener("onKeydown", function AddRecipeFormComponent_For_23_Template_lg_number_input_onKeydown_8_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.addLast());
    });
    \u0275\u0275template(12, AddRecipeFormComponent_For_23_ng_template_12_Template, 1, 0, "ng-template", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerStart(13, 30);
    \u0275\u0275elementStart(14, "lg-button", 31);
    \u0275\u0275listener("click", function AddRecipeFormComponent_For_23_Template_lg_button_click_14_listener() {
      const \u0275$index_39_r4 = \u0275\u0275restoreView(_r2).$index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.deleteIngredient(\u0275$index_39_r4));
    });
    \u0275\u0275element(15, "mat-icon", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(16, AddRecipeFormComponent_For_23_Conditional_16_Template, 1, 0, "hr", 33);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("formGroupName", \u0275$index_39_r4);
    \u0275\u0275advance();
    \u0275\u0275property("mobileMode", true);
    \u0275\u0275advance();
    \u0275\u0275property("size", "small");
    \u0275\u0275advance(2);
    \u0275\u0275property("resource", "recipes")("placeholder", \u0275\u0275pipeBind1(5, 15, "invoices.find-recipe"))("autoLoad", true);
    \u0275\u0275advance(2);
    \u0275\u0275property("resource", "products")("placeholder", \u0275\u0275pipeBind1(7, 17, "invoices.find-product"))("autoLoad", true);
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind2(11, 21, "recipe.form.ingredients.amount.placeholder", \u0275\u0275pureFunction1(24, _c4, \u0275\u0275pipeBind1(10, 19, "unit.long." + ((ctx_r2.form.value.ingredients == null ? null : ctx_r2.form.value.ingredients[\u0275$index_39_r4] == null ? null : ctx_r2.form.value.ingredients[\u0275$index_39_r4].unit) || ctx_r2.UnitValue.GRAM)))));
    \u0275\u0275advance(6);
    \u0275\u0275styleMap("danger");
    \u0275\u0275property("flat", true)("icon", true);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!(\u0275$index_39_r4 === \u0275$count_39_r5 - 1) ? 16 : -1);
  }
}
function AddRecipeFormComponent_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "lg-chips-list", 19);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    const categorySelect_r6 = \u0275\u0275reference(36);
...
var AddRecipeFormComponent = class _AddRecipeFormComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddRecipeFormComponent, selectors: [["lg-add-recipe-form"]], viewQuery: function AddRecipeFormComponent_Query(rf, ctx) {
  ...
  ])], decls: 45, vars: 46, consts: [["nameField", ""], ["amount", ""], ["categorySelect", ""], [3, "formGroup"], [3, "position"], ["lgExpand", "", 3, "label"], ["appendTo", "body", "formControlName", "name", "placeholde\u043A", "", 3, "key", "resource"], ["formControlName", "description", "lgExpand", "", "placeholder", ""], ["formControlName", "outcome_amount", "lgParseMath", "", "placeholder", ""], ["lgExtraTpl", "", "place", "after"], ["formArrayName", "ingredients", "lgExpand", "", 3, "size"], [3, "formGroupName"], [3, "click", "outlined", "size"], ["aria-hidden", "false", "fontIcon", "add", 3, "inline"], [2, "--control-bg", "var(--hr-bg-strong)", 3, "equal", "mobileMode"], [3, "label"], ["formControlName", "tags", 3, "multi", "resource"], [3, "position", "size"], ["appendTo", "body", "formControlName", "category_id", "lgExpand", "", 3, "resource"], [3, "control", "items"], ["formControlName", "master", 2, "--control-bg", "var(--hr-bg-strong)"], ["slot", "left"], ["slot", "right"], ["formControlName", "outcome_unit"], [3, "mobileMode"], [3, "size"], ["formControlName", "active_tab"], ["appendTo", "body", "formControlName", "recipe_id", "ngProjectAs", "recipes", 5, ["recipes"], 3, "resource", "placeholder", "autoLoad"], ["appendTo", "body", "formControlName", "product_id", "ngProjectAs", "products", 5, ["products"], 3, "resource", "placeholder", "autoLoad"], ["lgParseMath", "", "formControlName", "amount", 3, "onKeydown", "placeholder"], ["ngProjectAs", "rowActions", 5, ["rowActions"]], [3, "click", "flat", "icon"], ["aria-hidden", "false", "fontIcon", "close"], ["size", "2", "lgExpand", "", "color", "#fafafa"], ["formControlName", "unit"]], template: function AddRecipeFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "form", 3)(1, "lg-flex-column")(2, "lg-card")(3, "lg-flex-column", 4)(4, "lg-control", 5);
      \u0275\u0275pipe(5, "translate");
      \u0275\u0275element(6, "lg-autocomplete", 6, 0);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(14, "translate");
      \u0275\u0275elementStart(15, "lg-number-input", 8, 1);
      \u0275\u0275template(17, AddRecipeFormComponent_ng_template_17_Template, 1, 0, "ng-template", 9);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(18, "lg-control-group", 5);
      \u0275\u0275pipe(19, "translate");
      \u0275\u0275elementStart(20, "lg-flex-column", 4)(21, "lg-flex-column", 10);
      \u0275\u0275repeaterCreate(22, AddRecipeFormComponent_For_23_Template, 17, 26, "ng-container", 11, _forTrack02);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(27, "translate");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(28, "lg-flex-row", 14)(29, "lg-control", 15);
      \u0275\u0275pipe(30, "translate");
      \u0275\u0275element(31, "lg-tags-control", 16);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(32, "lg-control", 15);
      \u0275\u0275pipe(33, "translate");
      \u0275\u0275elementStart(34, "lg-flex-column", 17);
      \u0275\u0275element(35, "lg-multiselect", 18, 2);
      \u0275\u0275conditionalCreate(37, AddRecipeFormComponent_Conditional_37_Template, 1, 2, "lg-chips-list", 19);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(38, "lg-switch", 20)(39, "span", 21);
      \u0275\u0275text(40);
      \u0275\u0275pipe(41, "translate");
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("position", "start");
      \u0275\u0275advance();
      \u0275\u0275property("label", \u0275\u0275pipeBind1(14, 32, "recipe.form.outcome_amount.placeholder"));
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance();
      \u0275\u0275property("label", \u0275\u0275pipeBind1(30, 38, "recipe.form.tags.placeholder"));
      \u0275\u0275advance(2);
      \u0275\u0275property("multi", true)("resource", "tags");
      \u0275\u0275advance();
      \u0275\u0275property("label", \u0275\u0275pipeBind1(33, 40, "recipe.form.category.placeholder"));
      \u0275\u0275advance(2);
      \u0275\u0275property("position", "start")("size", "medium");
      \u0275\u0275advance();
      \u0275\u0275property("resource", "recipes-categories");
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.topCategories().length ? 37 : -1);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(41, 42, "recipe.form.chunk.label"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(44, 44, "recipe.form.master.label"));
    }
  }, dependencies: [
    ReactiveFormsModule,
    \u0275NgNoValidate,
...
(() => {
  ...
  <lg-flex-column>
                ...
                <ng-container [formGroupName]="i">
                  <lg-controls-row [mobileMode]="true">
                    <lg-flex-column [size]="'small'">
                      <lg-entity-item-selector formControlName="active_tab">
                      ...
                      <!--                                     [flat]="true"-->
                      <!--                                     [size]="'small'"-->
                      <!--                                     [style]="recipeFieldState()[i] ? 'secondary-dark' : 'primary'">-->
                      ...
                      <!--                                     [flat]="true"-->
                      <!--                                     [size]="'small'"-->
                      <!--                                     [style]="recipeFieldState()[i] ? 'primary' : 'secondary-dark'">-->
    ...
    <lg-switch formControlName="master"
      ...
      <span slot="left">{{ 'recipe.form.chunk.label' | translate }}</span>
      <span slot="right">{{ 'recipe.form.master.label' | translate }}</span>
    </lg-switch>
  </lg-flex-column>
</form>
` }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddRecipeFormComponent, { className: "AddRecipeFormComponent", filePath: "src/app/features/recipes/view/add-recipe/add-recipe-form.component.ts", lineNumber: 85 });
})();
...
function AddRecipeComponent_Conditional_4_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
...
function AddRecipeComponent_Conditional_4_Conditional_5_ng_template_0_Template(rf, ctx) {
  if (rf & 1) {
...
function AddRecipeComponent_Conditional_4_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, AddRecipeComponent_Conditional_4_Conditional_5_ng_template_0_Template, 3, 3, "ng-template", 7);
  }
}
function AddRecipeComponent_Conditional_4_ng_template_6_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-button", 11);
    \u0275\u0275listener("click", function AddRecipeComponent_Conditional_4_ng_template_6_Conditional_0_Template_lg_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
...
function AddRecipeComponent_Conditional_4_ng_template_6_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "lg-button", 11);
    \u0275\u0275listener("click", function AddRecipeComponent_Conditional_4_ng_template_6_Conditional_1_Template_lg_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(3);
...
function AddRecipeComponent_Conditional_4_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, AddRecipeComponent_Conditional_4_ng_template_6_Conditional_0_Template, 3, 6, "lg-button", 10)(1, AddRecipeComponent_Conditional_4_ng_template_6_Conditional_1_Template, 3, 6, "lg-button", 10);
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function AddRecipeComponent_Conditional_4_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
...
function AddRecipeComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "lg-flex-row", 5)(1, "lg-title", 6);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "lg-inline-separated-group");
    \u0275\u0275template(4, AddRecipeComponent_Conditional_4_ng_template_4_Template, 3, 8, "ng-template", 7);
    \u0275\u0275conditionalCreate(5, AddRecipeComponent_Conditional_4_Conditional_5_Template, 1, 0, null, 7);
    \u0275\u0275template(6, AddRecipeComponent_Conditional_4_ng_template_6_Template, 2, 1, "ng-template", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, AddRecipeComponent_Conditional_4_Conditional_7_Template, 4, 6, "small", 8);
  }
  if (rf & 2) {
    let tmp_3_0;
    let tmp_4_0;
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r0.draftRef() && ((tmp_4_0 = ctx_r0.formComponent()) == null ? null : tmp_4_0.form == null ? null : tmp_4_0.form.dirty) ? 5 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_5_0 = ctx_r0.recipe()) == null ? null : tmp_5_0.updatedAt) ? 7 : -1);
  }
}
...
var AddRecipeComponent = class _AddRecipeComponent {
  ...
  }, decls: 10, vars: 6, consts: [["size", "medium"], [3, "recipe"], [3, "mobileMode", "relaxed"], ["lgShrink", "", 3, "disabled", "style"], [3, "routerLink"], [3, "mobileMode", "center"], ["lgSelfStart", ""], ["lgInlineSeparatedGroup", ""], [1, "text-muted", "text-cursive"], [3, "flat", "link", "size"], ["lgShrink", "", 3, "style", "flat"], ["lgShrink", "", 3, "click", "flat"], ["lgShrink", "", 3, "click", "disabled"]], template: function AddRecipeComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(4, AddRecipeComponent_Conditional_4_Template, 8, 5)(5, AddRecipeComponent_Conditional_5_Template, 3, 3, "lg-title");
      \u0275\u0275elementEnd();
      \u0275\u0275element(6, "lg-add-recipe-form", 1);
      \u0275\u0275elementStart(7, "lg-flex-row", 2);
      \u0275\u0275conditionalCreate(8, AddRecipeComponent_Conditional_8_Template, 3, 4, "lg-button", 3)(9, AddRecipeComponent_Conditional_9_Template, 3, 4, "lg-button", 3);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      let tmp_0_0;
...
//# sourceMappingURL=chunk-34UVZM5E.js.map
