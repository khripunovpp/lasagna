...
// src/app/shared/view/ui/button.component.ts
var _c0 = ["*"];
...
var ButtonComponent = class _ButtonComponent {
  ...
  }, inputs: { style: [1, "style"], size: [1, "size"], outlined: [1, "outlined"], icon: [1, "icon"], flat: [1, "flat"], link: [1, "link"], noRightRadius: [1, "noRightRadius"], noLeftRadius: [1, "noLeftRadius"], noRadius: [1, "noRadius"], noTopRadius: [1, "noTopRadius"], noBottomRadius: [1, "noBottomRadius"], active: [1, "active"], disabled: [1, "disabled"], noScale: [1, "noScale"] }, outputs: { onClick: "onClick" }, ngContentSelectors: _c0, decls: 4, vars: 1, consts: [["content", ""], [1, "button", 3, "active", "flat", "disabled", "outlined", "icon", "no-bottom-radius", "no-left-radius", "no-radius", "no-right-radius", "no-top-radius", "no-scale", "ngClass", "routerLink", "routerLinkActive"], ["type", "button", 1, "button", 3, "active", "flat", "disabled", "outlined", "icon", "no-bottom-radius", "no-left-radius", "no-radius", "no-right-radius", "no-top-radius", "no-scale", "ngClass"], [1, "button", 3, "ngClass", "routerLink", "routerLinkActive"], [4, "ngTemplateOutlet"], ["type", "button", 1, "button", 3, "click", "ngClass", "disabled"], [1, "button__content"]], template: function ButtonComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
      \u0275\u0275conditionalCreate(0, ButtonComponent_Conditional_0_Template, 2, 27, "a", 1)(1, ButtonComponent_Conditional_1_Template, 2, 25, "button", 2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ButtonComponent, { className: "ButtonComponent", filePath: "src/app/shared/view/ui/button.component.ts", lineNumber: 335 });
})();

export {
  ButtonComponent
};
//# sourceMappingURL=chunk-WXEPVKGR.js.map
