...
var InputComponent = class _InputComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InputComponent, selectors: [["lg-input"]], contentQueries: function InputComponent_ContentQueries(rf, ctx, dirIndex) {
  ...
  ])], decls: 5, vars: 8, consts: [["input", ""], [1, "lg-input"], [1, "lg-input__before"], [1, "input", 3, "blur", "change", "focus", "input", "keydown.enter", "disabled", "placeholder", "value", "type"], [1, "lg-input__after"], [4, "ngTemplateOutlet"]], template: function InputComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(((tmp_7_0 = ctx.afterExtraTpl()) == null ? null : tmp_7_0.templateRef) ? 4 : -1);
    }
  }, dependencies: [
    FormsModule,
    NgTemplateOutlet
...
//# sourceMappingURL=chunk-RUDWEOA4.js.map
