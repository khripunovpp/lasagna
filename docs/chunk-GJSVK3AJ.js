...
(() => {
  ...
  }], null, { tabTemplates: [{ type: ContentChildren, args: [forwardRef(() => TabDirective), { isSignal: true }] }], flat: [{ type: Input, args: [{ isSignal: true, alias: "flat", required: false }] }], silent: [{ type: Input, args: [{ isSignal: true, alias: "silent", required: false }] }], scrollable: [{ type: Input, args: [{ isSignal: true, alias: "scrollable", required: false }] }] });
})();
(() => {
...
//# sourceMappingURL=chunk-GJSVK3AJ.js.map
