...
(() => {
  ...
  }], () => [], { rows: [{ type: Input, args: [{ isSignal: true, alias: "rows", required: false }] }], input: [{
    type: ViewChild,
    args: ["input", { static: true }]
  }], placeholder: [{ type: Input, args: [{ isSignal: true, alias: "placeholder", required: false }] }], readOnly: [{ type: Input, args: [{ isSignal: true, alias: "readOnly", required: false }] }], maxlength: [{ type: Input, args: [{ isSignal: true, alias: "maxlength", required: false }] }] });
})();
(() => {
...
//# sourceMappingURL=chunk-RJSN5CQV.js.map
